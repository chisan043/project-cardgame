(function (global) {
    ...
    function createDefaultBattleHudLayout(seed = {}) {
        const items = [
            createHudItem('玩家头像框', 'assets/ui/hud/player_panel/player_portrait_frame_asset_v1.webp', 14, 18, 202, 199, 10),
            ...
            createHudItem('敌方头像框', 'assets/ui/hud/enemy_panel/enemy_portrait_frame_asset_v1.webp', 1060, 21, 198, 199, 21),
            createHudItem('敌方名牌', 'assets/ui/hud/enemy_panel/enemy_nameplate_shell_asset_v1.webp', 788, 27, 440, 84, 22),
            createHudItem('敌方生命条框', 'assets/ui/hud/enemy_panel/enemy_hp_bar_shell_asset_v1.webp', 767, 67, 420, 64, 23),
            createHudItem('敌方护甲条框', 'assets/ui/hud/enemy_panel/enemy_armor_bar_shell_asset_v1.webp', 767, 106, 420, 84, 24),
            createHudItem('敌方状态栏', 'assets/ui/hud/status_bar/enemy_status_bar_shell_asset_v1.webp', 768, 112, 340, 48, 25, { fit: 'fill' }),
            createHudItem('敌方意图框', 'assets/ui/hud/enemy_intent/enemy_intent_panel_shell_asset_v1.webp', 765, 151, 360, 44, 26, { fit: 'fill' }),

            createHudItem('手牌承托', 'assets/ui/hud/hand_tray/hand_fan_tray_shell_asset_v1.webp', 210, 528, 860, 206, 30),
            createHudItem('结束回合按钮', 'assets/ui/hud/center_controls/end_turn_button_shell_asset_v1.webp', 964, 396, 292, 110, 31),
            createHudItem('回合计数器', 'assets/ui/hud/center_controls/turn_counter_inner_dial_asset_v1.webp', 607, 13, 67, 67, 31.5, { binding: 'turn-counter' }),
            createHudItem('抽牌堆', 'assets/ui/hud/piles/draw_pile_stack_asset_v1.webp', 36, 520, 88, 128, 32),
            createHudItem('弃牌堆', 'assets/ui/hud/piles/discard_pile_stack_asset_v1.webp', 1156, 520, 88, 128, 33),
            createHudItem('放逐堆', 'assets/ui/hud/piles/exile_pile_stack_asset_v1.webp', 1034, 520, 88, 128, 34),
            createHudItem('抽牌堆计数牌签', 'assets/ui/hud/piles/pile_count_plate_asset_v1_transparent.webp', 47, 641, 66, 34, 35),
            createHudItem('弃牌堆计数牌签', 'assets/ui/hud/piles/pile_count_plate_asset_v1_transparent.webp', 1167, 641, 66, 34, 36),
            createHudItem('放逐堆计数牌签', 'assets/ui/hud/piles/pile_count_plate_asset_v1_transparent.webp', 1045, 641, 66, 34, 37)
        ];
        for (let i = 0; i < 5; i += 1) {
            items.push(createHudItem(`能量晶石 ${i + 1}`, 'assets/ui/hud/player_panel/player_energy_gem_on_asset_v1.webp', 348 + i * 52, 238, 28, 44, 40 + i, { role: 'energy' }));
        }
