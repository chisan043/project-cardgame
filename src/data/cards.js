...
const CHARACTER_CARD_POOLS = {
    ...
    hero_mage: [
        ...
        { poolId: 'mage_arcane_mark', name: '紫焰刻印', type: '能力', cost: 3, icon: '🔮', val: 5, tags: ['附魔', '易伤'], rarity: '稀有', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', desc: '触发[附魔]并施加[易伤]。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_oath_watch', name: '守誓待击', type: '能力', cost: 1, icon: '👁️', val: 0, tags: ['反击'], buildTags: ['oathblade'], rarity: '普通', frameTheme: 'warrior', desc: '进入[反击]姿态。' },
