...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_crown_riposte', name: '王冠反斩', type: '能力', cost: 3, icon: '👑', val: 12, tags: ['反击', '庇护', '抽牌'], rarity: '史诗', desc: '获得 20 点庇护，进入[反击]姿态并抽取 3 张牌。' },
        ...
        { poolId: 'warrior_exile_judgement', name: '终誓处刑', type: '攻击', cost: 2, icon: '⚔️', val: 10, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', desc: '造成 10 点[穿甲]伤害，附带[重击]。不吃护盾收益，专注于直接斩杀。' },
        ...
        { poolId: 'warrior_execute_window', name: '斩首窗口', type: '攻击', cost: 2, icon: '⚔️', val: 8, tags: ['易伤', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', desc: '造成 8 点伤害并施加[易伤]。附带[重击]，适合作为处刑连斩的收束牌。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_disarm_press', name: '断腕缴械', type: '能力', cost: 2, icon: '⛓️', val: 0, tags: ['眩晕', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '施加[眩晕]并[抽牌]。用控制回合换取下一次[穿甲]斩。' },
        { poolId: 'warrior_heart_probe', name: '穿心试探', type: '攻击', cost: 1, icon: '🎯', val: 5, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '造成 5 点[穿甲]伤害并施加[虚弱]，用于试探敌人的反扑。' },
        ...
        { poolId: 'warrior_silent_lunge', name: '默步突刺', type: '攻击', cost: 2, icon: '🤫', val: 7, tags: ['穿甲', '眩晕'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '[穿甲]攻击并[眩晕]，用一拍停顿换下一回合的斩杀空间。' },
        { poolId: 'warrior_scaffold_cut', name: '刑架削锋', type: '攻击', cost: 2, icon: '⛓️', val: 7, tags: ['重击', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '不依赖护盾，靠[重击]制造伤害，同时用[虚弱]压低失败后的风险。' },
        { poolId: 'warrior_final_measure', name: '终裁量尺', type: '攻击', cost: 2, icon: '📏', val: 9, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', desc: '稳定的[穿甲][重击]收束牌，适合在易伤窗口已经打开后直接下判。' },
    ...
    hero_mage: [
        { poolId: 'mage_star_precharge', name: '星核预充', type: '能力', cost: 1, icon: '🔮', val: 0, tags: ['咏唱', '充能'], buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '积累[咏唱]并[充能]，完成一次等能量预备。' },
        ...
        { poolId: 'mage_reflect_veil', name: '倒影护幕', type: '防御', cost: 1, icon: '🛡️', val: 6, tags: ['回响', '保留'], buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '获得 6 点护盾并触发[回响]，打出后下回合回到手牌。' },
        ...
        { poolId: 'mage_lantern_chant', name: '灯火续咏', type: '能力', cost: 1, icon: '🏮', val: 4, tags: ['咏唱', '庇护'], buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '积累[咏唱]并获得 4 点[庇护]。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_shadow_line', name: '影羽切线', type: '攻击', cost: 1, icon: '🗡️', val: 6, tags: ['放逐', '连击'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 6 点伤害；若本回合已出牌则触发[连击]，随后[放逐]。' },
        ...
        { poolId: 'archer_rearguard', name: '游侠断后', type: '攻击', cost: 2, icon: '🏹', val: 8, tags: ['放逐', '重击'], buildTags: ['exile'], rarity: '史诗', frameTheme: 'archer', desc: '造成 8 点伤害，附带[重击]后[放逐]。' },
