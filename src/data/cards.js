...
const CHARACTER_CARD_POOLS = {
    ...
    hero_mage: [
        ...
        { poolId: 'mage_thunder', name: '裂界紫雷', type: '攻击', cost: 3, icon: '🌩️', val: 18, tags: ['爆发', '回响'], rarity: '史诗', desc: '造成高额伤害，消耗[咏唱]后让本牌再触发一次。' },
...
const BUILD_EXPANSION_CARDS = {
    ...
    hero_mage: [
        ...
        { poolId: 'mage_aftertone_flow', name: '余音导流', type: '能力', cost: 1, icon: '🎼', val: 0, tags: ['回响'], directEffects: { energy: true }, buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '回复 1 点能量，并让本牌再触发一次。' },
        ...
        { poolId: 'mage_echo_index', name: '回声索引', type: '能力', cost: 1, icon: '🔖', val: 0, tags: ['回响'], directEffects: { draw: true }, buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '抽 1 张牌，并让本牌再触发一次。' },
        { poolId: 'mage_glass_recursion', name: '玻璃递归', type: '攻击', cost: 1, icon: '💠', val: 7, tags: ['复刻', '穿甲'], buildTags: ['mirror'], rarity: '稀有', frameTheme: 'mage', desc: '造成 7 点穿甲伤害，并复制上一张非复刻牌。' },
        { poolId: 'mage_second_hand', name: '第二指针', type: '能力', cost: 2, icon: '🕰️', val: 4, tags: ['回响', '庇护'], buildTags: ['mirror'], rarity: '史诗', frameTheme: 'mage', desc: '本牌自回放，两次共获得 8 点庇护。' }
    ],
    hero_archer: [
