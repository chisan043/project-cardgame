...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_guard', name: '圣堂守势', type: '防御', cost: 2, icon: '🛡️', val: 10, tags: ['荆棘'], directEffects: { draw: true, protection: true }, preserveDirectEffects: true, rarity: '史诗', desc: '获得护盾与庇护，增加荆棘并抽 2 张牌。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_cycle_branch', name: '轮枝归射', type: '攻击', cost: 1, icon: '🧭', val: 6, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', desc: '造成 6 点伤害，并[回收] 1 张放逐区牌洗入牌库；回收放逐牌时造成 7 点[流动伤害]。' },
