...
const CHARACTER_CARD_POOLS = {
    ...
    hero_archer: [
        ...
        { poolId: 'archer_venom_flurry', name: '翠毒连矢', type: '攻击', cost: 1, icon: '☠️', val: 9, tags: ['剧毒', '虚弱'], buildTags: ['venom'], rarity: '普通', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', desc: '造成 9 点伤害，施加[剧毒]与[虚弱]。' },
        ...
        { poolId: 'archer_red_mark', name: '赤痕连矢', type: '攻击', cost: 1, icon: '🩸', val: 9, tags: ['出血', '追击', '虚弱'], buildTags: ['venom'], rarity: '普通', art: 'assets/cards/art/archer/archer_blood_release_art_v1.webp', desc: '造成 9 点伤害，附带[出血]、[追击]与[虚弱]。' },
        { poolId: 'archer_blood_release', name: '赤痕放血', type: '攻击', cost: 1, icon: '🩸', val: 10, tags: ['放血', '抽牌'], buildTags: ['venom'], rarity: '稀有', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', desc: '造成 10 点伤害，触发[放血]并[抽牌]。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 9, tags: ['血债'], bloodDebtDamageRatio: 1.25, bloodDebtRepay: 6, bloodDebtWeak: 1, bloodDebtClearDamage: 6, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 9 点伤害，追加当前血债 125% 的伤害，施加 1 层[虚弱]并偿还 6 点血债；若清偿血债，追加 6 点穿甲伤害。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_green_fang', name: '青牙试射', type: '攻击', cost: 0, icon: '☠️', val: 5, tags: ['剧毒', '销毁'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 5 点伤害，施加[剧毒]后[销毁]。' },
        { poolId: 'archer_poison_rain', name: '毒雨留弦', type: '攻击', cost: 2, icon: '🌧️', val: 12, tags: ['剧毒', '追击', '虚弱'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 12 点伤害，附带[追击]，施加[剧毒]与[虚弱]。' },
        { poolId: 'archer_hook_sinew', name: '断筋倒钩', type: '攻击', cost: 1, icon: '🪝', val: 8, tags: ['放血', '虚弱'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 8 点伤害，触发[放血]并施加[虚弱]。' },
        ...
        { poolId: 'archer_red_tide_bow', name: '赤潮短弓', type: '攻击', cost: 1, icon: '🏹', val: 8, tags: ['出血'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 8 点伤害并施加[出血]。' },
        { poolId: 'archer_throat_poison', name: '森毒封喉', type: '攻击', cost: 2, icon: '☠️', val: 12, tags: ['剧毒', '穿甲'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 12 点[穿甲]伤害并施加[剧毒]。' },
        ...
        { poolId: 'archer_poison_step', name: '毒痕护步', type: '防御', cost: 1, icon: '🥾', val: 11, tags: ['虚弱'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '获得 11 点护盾并施加[虚弱]。' },
        ...
        { poolId: 'archer_redline_hunt', name: '赤线追猎', type: '攻击', cost: 1, icon: '🧵', val: 9, tags: ['出血', '易伤'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 9 点伤害，施加[出血]与[易伤]。' },
