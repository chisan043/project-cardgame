...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_oath_finish', name: '血誓终击', type: '攻击', cost: 2, icon: '🩸', val: 10, tags: ['血誓', '吸血'], lifestealRatio: 0.6, bloodOathMissingRatio: 0.85, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 10 点伤害；追加已损生命 85% 的伤害；按 60% 伤害[吸血]。' }
    ],
    hero_mage: [
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        { poolId: 'warrior_crest_guard', name: '圣徽举盾', type: '防御', cost: 1, icon: '🔰', val: 8, tags: ['庇护', '保留'], buildTags: ['oathblade'], rarity: '普通', frameTheme: 'warrior', desc: '获得 8 点护盾，触发[庇护]并[保留]。' },
        { poolId: 'warrior_oath_charge', name: '王誓蓄锋', type: '防御', cost: 1, icon: '📜', val: 8, tags: ['保留'], buildTags: ['oathblade'], rarity: '稀有', frameTheme: 'warrior', desc: '获得 8 点护盾，打出后下回合回到手牌。' },
        ...
        { poolId: 'warrior_disarm_press', name: '锁腕断誓', type: '能力', cost: 2, icon: '⛓️', val: 0, tags: ['眩晕'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '施加[眩晕]并抽 1 张牌。' },
        ...
        { poolId: 'warrior_break_form', name: '破阵换位', type: '能力', cost: 1, icon: '🚩', val: 0, tags: ['重置', '销毁'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '自动丢弃除本牌外的未封印手牌并抽取等量的牌，随后[销毁]。' },
        ...
        { poolId: 'warrior_execute_step', name: '断刑步', type: '能力', cost: 1, icon: '👣', val: 0, tags: ['易伤', '销毁'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '施加[易伤]并抽 1 张牌，随后[销毁]。' },
        ...
        { poolId: 'warrior_devour_finish', name: '噬痕终击', type: '攻击', cost: 3, icon: '🩸', val: 16, tags: ['吸血', '血誓'], lifestealRatio: 0.6, bloodOathMissingRatio: 0.9, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 16 点伤害；追加已损生命 90% 的伤害；按 60% 伤害[吸血]。' },
        ...
        { poolId: 'warrior_oath_reversal', name: '誓壁反转', type: '防御', cost: 2, icon: '🔁', val: 10, tags: ['反击', '重置'], buildTags: ['oathblade'], rarity: '史诗', frameTheme: 'warrior', desc: '获得 10 点护盾，进入[反击]并[重置]手牌。' },
        { poolId: 'warrior_verdict_feint', name: '裁决虚锋', type: '攻击', cost: 1, icon: '⚖️', val: 6, tags: ['连击', '易伤', '销毁'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '造成 6 点伤害并施加[易伤]，随后[销毁]。' },
        { poolId: 'warrior_gap_finder', name: '窥隙烙印', type: '攻击', cost: 2, icon: '🔎', val: 10, tags: ['穿甲', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 10 点[穿甲]伤害并[抽牌]。' },
        { poolId: 'warrior_silent_lunge', name: '默步突刺', type: '攻击', cost: 2, icon: '🤫', val: 10, tags: ['穿甲', '眩晕'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 10 点[穿甲]伤害并[眩晕]。' },
    ...
    hero_mage: [
        ...
        { poolId: 'mage_mirror_trial', name: '镜页摹写', type: '能力', cost: 2, icon: '🪞', val: 0, tags: ['复刻'], directEffects: { draw: true }, buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '复制上一张非复刻牌，并抽 1 张牌。' },
        ...
        { poolId: 'mage_echo_shift', name: '回声换位', type: '能力', cost: 2, icon: '🔁', val: 0, tags: ['重置'], directEffects: { energy: true }, preserveDirectEffects: true, buildTags: ['mirror'], rarity: '稀有', frameTheme: 'mage', desc: '重置手牌，并回复 1 点能量。' },
        { poolId: 'mage_reflect_veil', name: '倒影护幕', type: '防御', cost: 2, icon: '🛡️', val: 8, tags: ['回响'], buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '获得 8 点护盾，并让本牌再触发一次。' },
    ...
    hero_archer: [
        { poolId: 'archer_leaf_sidestep', name: '踏叶侧射', type: '攻击', cost: 1, icon: '🍃', val: 8, tags: ['追击', '自然'], buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '造成 8 点伤害，触发[追击]与[自然]。' },
        ...
        { poolId: 'archer_backstep', name: '回风掠步', type: '防御', cost: 2, icon: '🪶', val: 11, tags: ['自然', '重置'], buildTags: ['gale'], rarity: '稀有', frameTheme: 'archer', desc: '获得 11 点护盾，触发[自然]并[重置]手牌。' },
        { poolId: 'archer_quick_corridor', name: '急羽破廊', type: '攻击', cost: 2, icon: '💨', val: 13, tags: ['追击', '穿甲'], buildTags: ['gale'], rarity: '稀有', frameTheme: 'archer', desc: '造成 13 点[穿甲]伤害，附带[追击]。' },
        ...
        { poolId: 'archer_green_mist_end', name: '绿雾终幕', type: '攻击', cost: 2, icon: '☠️', val: 18, tags: ['剧毒', '放血', '虚弱'], buildTags: ['venom'], rarity: '史诗', frameTheme: 'archer', desc: '造成 18 点伤害，施加[剧毒]与[虚弱]并触发[放血]。' },
        ...
        { poolId: 'archer_sky_skim', name: '掠空羽矢', type: '攻击', cost: 1, icon: '🪶', val: 7, tags: ['追击', '销毁'], buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '造成 7 点伤害，触发[追击]后[销毁]。' },
        { poolId: 'archer_crosswind_guard', name: '侧风护步', type: '防御', cost: 1, icon: '🥾', val: 9, tags: ['自然', '保留'], buildTags: ['gale', 'venom', 'exile'], rarity: '稀有', frameTheme: 'archer', desc: '获得 9 点护盾，触发[自然]并[保留]。' },
...
const STARTER_DECKS = {
    starter_warrior: {
        ...
        cards: [
            ...
            { poolId: 'warrior_magic_sword', name: '魔剑', type: '攻击', cost: 1, icon: '🗡️', val: 4, tags: [], magicSwordGrowth: 1, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_magic_sword_art_v1.png', desc: '造成 4 点伤害；自身实际失去生命或本牌击杀敌人时，永久 +1 伤害。' },
            { poolId: 'starter_warrior_flaw', name: '裂隙刻印', type: '能力', cost: 1, icon: '🎯', val: 0, tags: ['易伤'], buildTags: ['execution'], directEffects: { draw: true }, rarity: '普通', frameTheme: 'warrior', desc: '施加[易伤]并抽 1 张牌。' }
        ]
    },
    starter_mage: {
        roleId: 'hero_mage',
