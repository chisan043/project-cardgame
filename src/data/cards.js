...
const CARD_ART_REGISTRY = {
    ...
    '圣剑突击': '新角色一/角色一_卡面插画_圣剑突击.png',
    '遗迹立誓': '新角色一/角色一_卡面插画_遗迹立誓.png',
    '紫焰爆裂': '角色二/角色二_卡面插画_紫焰爆裂.png',
    '遗迹咏唱': '角色二/角色二_卡面插画_遗迹咏唱.png',
    '拉弓瞄准': '新角色三/角色三_卡面插画_拉弓瞄准.png',
    '疾风连射': '新角色三/角色三_卡面插画_疾风连射.png',

    // Generated unframed card art for standard pool cards.
    '盾墙反身': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_盾墙反身.png',
    '誓约追击': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_誓约追击.png',
    '圣堂守势': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_圣堂守势.png',
    '圣剑解放': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_圣剑解放.png',
    '破晓格挡': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_破晓格挡.png',
    '裂光一闪': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_裂光一闪.png',
    '王冠反斩': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_王冠反斩.png',
    '铁壁圣痕': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_铁壁圣痕.png',
    '血誓斩': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_血誓斩.png',
    '棘甲冲锋': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_棘甲冲锋.png',
    '战旗压阵': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_战旗压阵.png',
    '血祭壁垒': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_血祭壁垒.png',
    '誓约留锋': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_誓约留锋.png',
    '魂誓换锋': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_魂誓换锋.png',
    '狂誓裂斩': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_狂誓裂斩.png',
    '终誓裁断': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_终誓裁断.png',
    '紫焰火花': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_紫焰火花.png',
    '魔流庇护': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_魔流庇护.png',
    '虚空导引': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_虚空导引.png',
    '星火连祷': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_星火连祷.png',
    '星屑预兆': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_星屑预兆.png',
    '余烬点燃': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_余烬点燃.png',
    '法环回流': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_法环回流.png',
    '裂界紫雷': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_裂界紫雷.png',
    '星环复写': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_星环复写.png',
    '燃魂导流': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_燃魂导流.png',
    '回声护幕': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_回声护幕.png',
    '虚弱星尘': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_虚弱星尘.png',
    '紫焰刻印': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_紫焰刻印.png',
    '星缚咒印': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_星缚咒印.png',
    '咒回星环': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_咒回星环.png',
    '裂星禁术': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_裂星禁术.png',
    '林风整备': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_林风整备.png',
    '猎手翻步': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_猎手翻步.png',
    '狩影穿枝': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_狩影穿枝.png',
    '森冠齐射': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_森冠齐射.png',
    '森息伏击': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_森息伏击.png',
    '风羽换位': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_风羽换位.png',
    '鹰眼贯枝': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_鹰眼贯枝.png',
    '回环箭雨': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_回环箭雨.png',
    '回风藏箭': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_回风藏箭.png',
    '逐影放矢': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_逐影放矢.png',
    '轮枝归射': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_轮枝归射.png',
    '拾羽连步': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_拾羽连步.png',
    '翠毒连矢': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_翠毒连矢.png',
    '林魂招矢': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_林魂招矢.png',
    '赤痕放血': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_赤痕放血.png',
    '逐风绝矢': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_逐风绝矢.png',
    '古誓护印': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_古誓护印.png',
    '星轨换手': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_星轨换手.png',
    '碎星短刃': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_碎星短刃.png',
    '圣像微光': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_圣像微光.png',
    '回音残卷': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_回音残卷.png',

    // Starter and temporary cards reuse the closest generated art so the demo does not fall back to emoji.
    '基础斩击': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_誓约追击.png',
    '基础防御': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_盾墙反身.png',
    '基础法弹': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_紫焰火花.png',
    '秘仪预兆': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_魔流庇护.png',
    '秘仪屏障': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_魔流庇护.png',
    '基础射击': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_狩影穿枝.png',
    '林地回避': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_猎手翻步.png',
    '飞刀': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_碎星短刃.png',
    '厄运印记': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_回音残卷.png'
};

const CARD_TYPE_ART_FALLBACK = {
    '攻击': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_碎星短刃.png',
    '防御': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_古誓护印.png',
    '能力': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_星轨换手.png',
    '诅咒': '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/中立法则_回音残卷.png'
};

const CARD_FRAME_ASSETS = {
    warrior: '卡牌设计/教堂彩窗赛璐璐/卡框UI/圣剑彩窗框.png',
    mage: '卡牌设计/教堂彩窗赛璐璐/卡框UI/秘法彩窗框.png',
    archer: '卡牌设计/教堂彩窗赛璐璐/卡框UI/森灵彩窗框.png',
    neutral: '卡牌设计/教堂彩窗赛璐璐/卡框UI/中立彩窗框.png'
};
...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_vow_slash', name: '血誓斩', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['圣剑', '吸血'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_血誓斩.png', desc: '造成 7 点伤害。附带[圣剑]与[吸血]，溢出治疗可配合战士遗物转成护盾。' },
        { poolId: 'warrior_thorn_charge', name: '棘甲冲锋', type: '攻击', cost: 2, icon: '🌹', val: 10, tags: ['圣剑', '荆棘'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_棘甲冲锋.png', desc: '造成 10 点伤害。附带[圣剑]与[荆棘]，护盾越高越容易触发盾棘共鸣。' },
        { poolId: 'warrior_banner_guard', name: '战旗压阵', type: '能力', cost: 1, icon: '🚩', val: 5, tags: ['庇护', '抽牌'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_战旗压阵.png', desc: '触发[庇护]并[抽牌]。若已有护盾，战士联动会额外加固护盾。' },
        { poolId: 'warrior_blood_wall', name: '血祭壁垒', type: '能力', cost: 1, icon: '🛡️', val: 5, tags: ['血祭', '庇护', '荆棘'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_血祭壁垒.png', desc: '触发[血祭]与[庇护]，并获得[荆棘]。战士会把血祭转成护盾，为盾棘和下一次圣剑铺垫。' },
        { poolId: 'warrior_oath_retainer', name: '誓约留锋', type: '防御', cost: 1, icon: '🔰', val: 9, tags: ['保留', '充能'], rarity: '普通', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_誓约留锋.png', desc: '获得 9 点护盾。附带[保留]与[充能]，战士会因防御保留额外获得护盾。' },
        { poolId: 'warrior_soul_oath', name: '魂誓换锋', type: '能力', cost: 1, icon: '📖', val: 5, tags: ['充能', '抽牌', '庇护'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_魂誓换锋.png', desc: '触发[充能]、[抽牌]与[庇护]。把节奏转成护盾，为后续圣剑攻击铺垫。' },
        ...
        { poolId: 'warrior_frenzy_cleave', name: '狂誓裂斩', type: '攻击', cost: 2, icon: '🔥', val: 9, tags: ['狂热', '圣剑', '重击'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_狂誓裂斩.png', desc: '丢弃 1 张手牌获得[狂热]，随后以[圣剑]与[重击]造成重击伤害。' },
        { poolId: 'warrior_exile_judgement', name: '终誓裁断', type: '攻击', cost: 2, icon: '⚔️', val: 16, tags: ['圣剑', '重击', '放逐'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_终誓裁断.png', desc: '造成 16 点伤害，附带[圣剑]、[重击]与[放逐]。一次性终结牌，放逐威能会额外提高伤害。' }
    ],
    hero_mage: [
        ...
        { poolId: 'mage_star_copy', name: '星环复写', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['复刻', '咏唱'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_虚空导引.png', desc: '触发[复刻]并积累[咏唱]。法师联动会让复刻再额外推进咏唱。' },
        { poolId: 'mage_ember_flow', name: '燃魂导流', type: '攻击', cost: 1, icon: '🔥', val: 5, tags: ['爆发', '燃烧', '充能'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_余烬点燃.png', desc: '造成 5 点伤害。附带[爆发]、[燃烧]与[充能]，状态词条会为法师标记下一次伤害。' },
        ...
        { poolId: 'mage_echo_veil', name: '回声护幕', type: '能力', cost: 1, icon: '🛡️', val: 0, tags: ['回响', '治愈'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_魔流庇护.png', desc: '触发[回响]与[治愈]。法师会因回响或受伤治疗积累咏唱。' },
        { poolId: 'mage_void_dust', name: '虚弱星尘', type: '攻击', cost: 1, icon: '✦', val: 6, tags: ['爆发', '虚弱'], rarity: '普通', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_星屑预兆.png', desc: '造成 6 点伤害。附带[爆发]与[虚弱]，有咏唱时会标记下一次伤害。' },
        { poolId: 'mage_arcane_mark', name: '紫焰刻印', type: '能力', cost: 1, icon: '🔮', val: 5, tags: ['附魔', '易伤'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_裂界紫雷.png', desc: '触发[附魔]并施加[易伤]。法师可把状态词条转成下一次爆发的额外标记。' },
        { poolId: 'mage_stasis_hex', name: '星缚咒印', type: '能力', cost: 2, icon: '⛓️', val: 0, tags: ['眩晕', '诅咒', '咏唱'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_虚空导引.png', desc: '施加[眩晕]与[诅咒]，并积累[咏唱]。控制与爆发铺垫合一。' },
        { poolId: 'mage_curse_echo', name: '咒回星环', type: '能力', cost: 1, icon: '🌑', val: 0, tags: ['诅咒', '回响'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_法环回流.png', desc: '施加[诅咒]并触发[回响]。法师会因回响额外积累咏唱，并用诅咒标记下一次伤害。' },
        { poolId: 'mage_exile_nova', name: '裂星禁术', type: '攻击', cost: 2, icon: '🌌', val: 15, tags: ['爆发', '穿甲', '放逐'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_裂界紫雷.png', desc: '造成 15 点穿甲伤害，附带[爆发]与[放逐]。一次性禁术，放逐威能会额外提高伤害。' }
    ],
    hero_archer: [
        ...
        { poolId: 'archer_hidden_arrow', name: '回风藏箭', type: '能力', cost: 1, icon: '🪶', val: 6, tags: ['保留', '蓄力'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_风羽换位.png', desc: '获得风势。附带[保留]与[蓄力]，弓手会因保留额外获得风势。' },
        { poolId: 'archer_exile_shot', name: '逐影放矢', type: '攻击', cost: 1, icon: '🏹', val: 8, tags: ['放逐', '连射'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_狩影穿枝.png', desc: '造成 8 点伤害。附带[放逐]与[连射]，弓手会因放逐获得风势，且放逐威能会额外提高伤害。' },
        { poolId: 'archer_cycle_branch', name: '轮枝归射', type: '攻击', cost: 2, icon: '🧭', val: 9, tags: ['轮回', '连射'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_回环箭雨.png', desc: '造成 9 点伤害。可触发[轮回]并[连射]，回收放逐牌时获得风势。' },
        { poolId: 'archer_pick_feather', name: '拾羽连步', type: '能力', cost: 1, icon: '🍃', val: 0, tags: ['拾遗', '自然'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_猎手翻步.png', desc: '触发[拾遗]与[自然]。弓手会因回收墓地牌获得风势。' },
        { poolId: 'archer_venom_flurry', name: '翠毒连矢', type: '攻击', cost: 1, icon: '☠️', val: 5, tags: ['连射', '剧毒'], rarity: '普通', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_森息伏击.png', desc: '造成 5 点伤害。附带[连射]与[剧毒]，适合把风势追射转成多段上毒。' },
        ...
        { poolId: 'archer_soul_return', name: '林魂招矢', type: '能力', cost: 1, icon: '🏮', val: 0, tags: ['招魂', '自然'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_林风整备.png', desc: '从放逐区选择 1 张牌回到手牌，并触发[自然]。弓手会因招魂获得风势。' },
        { poolId: 'archer_red_mark', name: '赤痕连矢', type: '攻击', cost: 1, icon: '🩸', val: 5, tags: ['出血', '连射'], rarity: '普通', desc: '造成 5 点伤害。附带[出血]与[连射]，专门负责快速叠出血层数。' },
        { poolId: 'archer_blood_release', name: '赤痕放血', type: '攻击', cost: 1, icon: '🩸', val: 6, tags: ['放血', '连射'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_森息伏击.png', desc: '造成 6 点伤害，然后引爆敌方已有[出血]层数；[连射]让引爆回合更灵动。' },
        { poolId: 'archer_exile_storm', name: '逐风绝矢', type: '攻击', cost: 2, icon: '💨', val: 12, tags: ['放逐', '连射', '多段'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_回环箭雨.png', desc: '造成 12 点伤害，附带[放逐]、[连射]与[多段]。一次性爆发，会获得放逐威能。' }
    ]
};
