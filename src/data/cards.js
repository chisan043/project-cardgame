...
const BUILD_EXPANSION_CARDS = {
    ...
    hero_mage: [
        ...
        { poolId: 'mage_calamity_tune', name: '厄星调律', type: '攻击', cost: 2, icon: '💠', val: 13, tags: ['诅咒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 13 点伤害，施加[诅咒]并抽 1 张牌。' },
