...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_bloodlet_cleave', name: '断誓开锋', type: '攻击', cost: 1, icon: '⚔️', val: 7, tags: ['放血'], bloodDebtDamageRatio: 0.75, bloodDebtRepayFromBleed: 0.5, bloodDebtClearDamage: 6, bloodDebtClearHeal: 3, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 7 点伤害，追加血债 75% 并[放血]。放血伤害 50% 偿债；清债时 +6 伤害并回 3 生命。' },
        ...
        { poolId: 'warrior_lifebite', name: '偿命追击', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['吸血'], lifestealRatio: 1, bloodDebtDamageRatio: 0.75, bloodDebtClearDamage: 7, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 7 点伤害，追加血债 75%，并以全部伤害[吸血]；清债时 +7 伤害。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 6, tags: ['血债'], bloodDebtDamageRatio: 0.75, bloodDebtRepay: 4, bloodDebtClearDamage: 6, bloodDebtClearHeal: 4, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 6 点伤害，追加血债 75%，偿还 4 血债；清债时 +6 伤害并回 4 生命。' },
        ...
        { poolId: 'warrior_blood_tide', name: '血潮续斩', type: '攻击', cost: 2, icon: '🌊', val: 9, tags: ['放血', '血债'], bloodDebtDamageRatio: 1.25, bloodDebtRepayFromBleed: 0.75, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 9 点伤害，追加血债 125%；[放血]伤害 75% 偿债。' },
        ...
        { poolId: 'warrior_devour_finish', name: '噬痕终击', type: '攻击', cost: 3, icon: '🩸', val: 16, tags: ['放血', '吸血'], bloodDebtDamageRatio: 2, bloodDebtRepayFromBleed: 1, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 16 点伤害，追加血债 2 倍；[放血]后[吸血]，两段均可偿债。' },
