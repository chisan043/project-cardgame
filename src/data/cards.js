...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_guard', name: '圣堂守势', type: '防御', cost: 2, icon: '🛡️', val: 10, tags: ['庇护', '荆棘', '抽牌'], rarity: '史诗', desc: '获得护盾与庇护，增加荆棘并抽 2 张牌。' },
        ...
        { poolId: 'warrior_crown_riposte', name: '王冠反斩', type: '攻击', cost: 3, icon: '👑', val: 12, tags: ['反击', '庇护', '重击'], rarity: '史诗', desc: '发动高威力[重击]，获得庇护并进入[反击]姿态。' },
        ...
        { poolId: 'warrior_banner_guard', name: '誓旗护阵', type: '能力', cost: 1, icon: '🚩', val: 8, tags: ['庇护', '抽牌'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_banner_guard_art_v1.webp', desc: '获得 8 点庇护并抽 1 张牌。' },
        ...
        { poolId: 'warrior_soul_oath', name: '魂誓换锋', type: '能力', cost: 1, icon: '📖', val: 6, tags: ['充能', '抽牌', '庇护'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_soul_oath_art_v1.webp', desc: '获得 6 点庇护、回复 1 点能量并抽 1 张牌。' },
        ...
        { poolId: 'warrior_bloodlet_cleave', name: '断誓开锋', type: '攻击', cost: 1, icon: '⚔️', val: 10, tags: ['血债'], bloodDebtDamageRatio: 1.25, bloodDebtRepay: 6, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 10 点伤害，追加当前血债 125% 的伤害，并偿还 6 点血债。' },
        { poolId: 'warrior_venom_scar', name: '破势剑痕', type: '攻击', cost: 1, icon: '☠️', val: 9, tags: ['易伤', '穿甲'], buildTags: ['execution'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '造成 9 点[穿甲]伤害并施加[易伤]。为后续处刑攻击打开缺口。' },
        ...
        { poolId: 'warrior_exile_judgement', name: '终誓处刑', type: '攻击', cost: 2, icon: '⚔️', val: 14, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', desc: '造成 14 点[穿甲]伤害，附带[重击]。不吃护盾收益，专注于直接斩杀。' },
        { poolId: 'warrior_flaw_mark', name: '破绽刻印', type: '能力', cost: 0, icon: '🎯', val: 0, tags: ['易伤', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '免费施加[易伤]并[抽牌]。用低费标记为下一次穿甲或重击创造窗口。' },
        { poolId: 'warrior_duel_cut', name: '断甲决斗', type: '攻击', cost: 1, icon: '🗡️', val: 10, tags: ['穿甲', '连击'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '造成 10 点伤害。若本回合已打出过其他牌，[连击]会提高伤害，并且[穿甲]无视护甲。' },
        { poolId: 'warrior_execute_window', name: '斩首窗口', type: '攻击', cost: 2, icon: '⚔️', val: 12, tags: ['易伤', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', desc: '造成 12 点伤害并施加[易伤]。附带[重击]，适合作为处刑连斩的收束牌。' },
        ...
        { poolId: 'warrior_lifebite', name: '偿命追击', type: '攻击', cost: 1, icon: '🩸', val: 10, tags: ['吸血'], lifestealRatio: 1, bloodDebtDamageRatio: 1.25, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 10 点伤害，追加当前血债 125% 的伤害，并以全部伤害[吸血]。' },
        { poolId: 'warrior_blood_debt', name: '血债清算', type: '攻击', cost: 2, icon: '🩸', val: 14, tags: ['血债', '吸血'], bloodDebtDamageRatio: 2.5, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 14 点伤害，并追加当前血债 250% 的伤害，随后[吸血]偿债。' }
    ],
    hero_mage: [
        ...
        { poolId: 'mage_spark', name: '紫焰火花', type: '攻击', cost: 1, icon: '🔥', val: 9, tags: ['爆发', '燃烧'], rarity: '普通' },
        ...
        { poolId: 'mage_venom_sigils', name: '厄星符阵', type: '能力', cost: 0, icon: '☠️', val: 0, tags: ['虚弱'], directEffects: { draw: true }, buildTags: ['calamity'], rarity: '普通', art: 'assets/cards/art/mage/mage_stasis_hex_art_v1.webp', desc: '免费施加[虚弱]并抽 1 张牌。' },
        { poolId: 'mage_blood_orbit', name: '灼月星轨', type: '攻击', cost: 1, icon: '🔥', val: 7, tags: ['燃烧'], buildTags: ['calamity'], rarity: '稀有', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', desc: '造成 7 点伤害并施加[燃烧]。' },
        { poolId: 'mage_bloodlet_omen', name: '断咒预兆', type: '能力', cost: 1, icon: '🌑', val: 0, tags: ['诅咒'], directEffects: { draw: true }, buildTags: ['calamity'], rarity: '稀有', art: 'assets/cards/art/mage/mage_curse_echo_art_v1.webp', desc: '施加[诅咒]并抽 1 张牌。' },
        ...
        { poolId: 'mage_void_dust', name: '虚弱星尘', type: '攻击', cost: 1, icon: '✦', val: 8, tags: ['虚弱', '抽牌'], buildTags: ['calamity'], rarity: '普通', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', desc: '造成 8 点伤害，施加[虚弱]并[抽牌]。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_exile_shot', name: '逐影放矢', type: '攻击', cost: 1, icon: '🏹', val: 7, tags: ['放逐'], buildTags: ['exile'], rarity: '稀有', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', desc: '造成 7 点伤害并[放逐]；进入放逐区时造成 5 点[流动伤害]。' },
        ...
        { poolId: 'archer_venom_flurry', name: '翠毒连矢', type: '攻击', cost: 1, icon: '☠️', val: 7, tags: ['剧毒', '虚弱'], buildTags: ['venom'], rarity: '普通', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', desc: '造成 7 点伤害，施加[剧毒]与[虚弱]。' },
        ...
        { poolId: 'archer_red_mark', name: '赤痕连矢', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['出血', '追击'], buildTags: ['venom'], rarity: '普通', art: 'assets/cards/art/archer/archer_blood_release_art_v1.webp', desc: '造成 7 点伤害，附带[出血]与[追击]。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_disarm_press', name: '断腕缴械', type: '能力', cost: 0, icon: '⛓️', val: 0, tags: ['眩晕', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '免费施加[眩晕]并[抽牌]。用控制回合换取下一次[穿甲]斩。' },
        { poolId: 'warrior_heart_probe', name: '穿心试探', type: '攻击', cost: 2, icon: '🎯', val: 13, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 13 点[穿甲]伤害并施加[虚弱]，在斩杀窗口未成熟时压低反扑风险。' },
        { poolId: 'warrior_lone_double', name: '孤锋二连', type: '攻击', cost: 2, icon: '⚔️', val: 8, tags: ['连击', '重击'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '先出别的牌后再用它，[连击]与[重击]共同放大这次收束。' },
        ...
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 8, tags: ['血债'], bloodDebtDamageRatio: 1.25, bloodDebtRepay: 6, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 8 点伤害，追加当前血债 125% 的伤害，并偿还 6 点血债。' },
        { poolId: 'warrior_boiling_drive', name: '沸血突进', type: '攻击', cost: 1, icon: '🔥', val: 8, tags: ['血债'], bloodDebtGain: 3, bloodDebtDamageRatio: 2, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '获得 3 点[血债]。造成 8 点伤害，并追加当前血债 200% 的伤害。' },
        ...
        { poolId: 'warrior_blood_tide', name: '血潮续斩', type: '攻击', cost: 2, icon: '🌊', val: 13, tags: ['放血', '血债'], bloodDebtDamageRatio: 1.75, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 13 点伤害，追加当前血债 175% 的伤害，并触发[放血]。' },
        ...
        { poolId: 'warrior_life_contract', name: '回生血契', type: '能力', cost: 1, icon: '📖', val: 0, tags: ['血债'], bloodDebtRepay: 8, drawCount: 1, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '偿还 8 点血债并抽 1 张牌。' },
        ...
        { poolId: 'warrior_devour_finish', name: '噬痕终击', type: '攻击', cost: 3, icon: '🩸', val: 22, tags: ['吸血'], lifestealRatio: 1, bloodDebtDamageRatio: 2.5, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 22 点伤害，追加当前血债 250% 的伤害，并以全部伤害[吸血]。' },
        ...
        { poolId: 'warrior_final_measure', name: '终裁量尺', type: '攻击', cost: 2, icon: '📏', val: 13, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', desc: '稳定的[穿甲][重击]收束牌，适合在易伤窗口已经打开后直接下判。' },
        { poolId: 'warrior_crimson_pause', name: '猩红喘息', type: '能力', cost: 0, icon: '🫀', val: 0, tags: ['血债', '保留'], bloodDebtRepay: 8, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '免费偿还 8 点血债并抽 1 张牌。打出后下回合回到手牌。' }
    ],
    hero_mage: [
        ...
        { poolId: 'mage_star_ward', name: '残星护文', type: '防御', cost: 1, icon: '🛡️', val: 11, tags: ['咏唱', '保留'], buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '获得 11 点护盾，积累[咏唱]并[保留]。' },
        ...
        { poolId: 'mage_star_surge', name: '星涌短波', type: '攻击', cost: 1, icon: '⚡', val: 9, tags: ['爆发', '充能'], buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '造成 9 点伤害，附带[爆发]与[充能]。' },
        ...
        { poolId: 'mage_calamity_tune', name: '灾厄调谐', type: '攻击', cost: 1, icon: '💠', val: 8, tags: ['诅咒'], buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 8 点伤害并施加[诅咒]。' },
        { poolId: 'mage_lantern_chant', name: '灯火续咏', type: '能力', cost: 0, icon: '🏮', val: 7, tags: ['咏唱', '庇护'], buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '免费积累[咏唱]并获得 7 点[庇护]。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_green_fang', name: '青牙试射', type: '攻击', cost: 0, icon: '☠️', val: 4, tags: ['剧毒', '销毁'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 4 点伤害，施加[剧毒]后[销毁]。' },
        { poolId: 'archer_poison_rain', name: '毒雨留弦', type: '攻击', cost: 2, icon: '🌧️', val: 9, tags: ['剧毒', '追击'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 9 点伤害，附带[追击]并施加[剧毒]。' },
        ...
        { poolId: 'archer_spore_shadow', name: '孢影伏击', type: '能力', cost: 0, icon: '🍄', val: 0, tags: ['剧毒', '抽牌'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '免费施加[剧毒]并[抽牌]。' },
        ...
        { poolId: 'archer_red_tide_bow', name: '赤潮短弓', type: '攻击', cost: 1, icon: '🏹', val: 7, tags: ['出血'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 7 点伤害并施加[出血]。' },
        ...
        { poolId: 'archer_redline_hunt', name: '赤线追猎', type: '攻击', cost: 1, icon: '🧵', val: 8, tags: ['出血', '易伤'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 8 点伤害，施加[出血]与[易伤]。' },
        { poolId: 'archer_bitter_vine', name: '苦藤攀附', type: '能力', cost: 1, icon: '🌿', val: 0, tags: ['剧毒', '充能'], directEffects: { draw: true }, buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '施加[剧毒]、[充能]并抽 1 张牌。' },
        ...
        { poolId: 'archer_venom_blood_shift', name: '毒血换羽', type: '能力', cost: 1, icon: '🪶', val: 0, tags: ['放血', '充能'], directEffects: { draw: true }, buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '触发[放血]、[充能]并抽 1 张牌。' },
        ...
        { poolId: 'archer_returning_feather', name: '折返羽刃', type: '攻击', cost: 1, icon: '🪶', val: 7, tags: ['放逐'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 7 点伤害后[放逐]；进入放逐区时造成 5 点[流动伤害]。' },
        ...
        { poolId: 'archer_shadow_line', name: '影羽切线', type: '攻击', cost: 1, icon: '🗡️', val: 7, tags: ['放逐'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 7 点伤害后[放逐]；进入放逐区时造成 5 点[流动伤害]。' },
        ...
        { poolId: 'archer_nest_track', name: '回巢轨迹', type: '攻击', cost: 2, icon: '🧭', val: 8, tags: ['回收', '出血'], buildTags: ['exile', 'venom'], rarity: '史诗', frameTheme: 'archer', desc: '造成 8 点伤害，施加[出血]，并[回收] 1 张放逐区牌洗入牌库；回收放逐牌时造成 7 点[流动伤害]。' },
...
const STARTER_DECKS = {
    ...
    starter_mage: {
        roleId: 'hero_mage',
        cards: [
            { poolId: 'starter_mage_bolt', name: '基础法弹', type: '攻击', cost: 1, icon: '🪄', val: 10, tags: [], rarity: '普通', copies: 4, frameTheme: 'mage', desc: '造成 10 点伤害。' },
            { poolId: 'starter_mage_heal', name: '基础愈流', type: '能力', cost: 0, icon: '✚', val: 0, tags: ['治愈'], buildNeutral: true, rarity: '普通', copies: 2, frameTheme: 'mage', desc: '免费回复 8 点生命。' },
    ...
    starter_archer: {
        ...
        cards: [
            ...
            { poolId: 'starter_archer_venom', name: '青牙试射', type: '攻击', cost: 1, icon: '☠️', val: 6, tags: ['剧毒'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 6 点伤害并施加[剧毒]。' },
            { poolId: 'starter_archer_exile', name: '逐影放矢', type: '攻击', cost: 1, icon: '🏹', val: 7, tags: ['放逐'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 7 点伤害并[放逐]；进入放逐区时造成 5 点[流动伤害]。' },
