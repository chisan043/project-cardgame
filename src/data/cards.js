...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_wall', name: '血痕引路', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['血誓'], bloodOathCost: 5, bloodDebtBleed: 6, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '失去 5 点生命；造成 7 点伤害并施加 6 层出血。' },
        ...
        { poolId: 'warrior_blood_drive', name: '不赦血契', type: '攻击', cost: 2, icon: '🩸', val: 9, tags: ['血誓', '眩晕'], bloodOathCost: 6, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '失去 6 点生命；造成 9 点伤害并[眩晕]。' },
    ...
    hero_mage: [
        ...
        { poolId: 'mage_ember_flow', name: '燃魂导流', type: '攻击', cost: 2, icon: '🔥', val: 5, tags: ['爆发', '燃烧', '充能'], rarity: '稀有', art: 'assets/cards/art/mage/mage_ember_art_v1.webp', desc: '造成 5 点[爆发]伤害，施加[燃烧]并回复 1 点能量。' },
        ...
        { poolId: 'mage_void_dust', name: '衰星尘', type: '攻击', cost: 2, icon: '✦', val: 9, tags: ['虚弱'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '普通', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', desc: '造成 9 点伤害，施加[虚弱]并抽 1 张牌。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_step', name: '踏叶掠影', type: '能力', cost: 2, icon: '🥾', val: 5, tags: ['自然'], directEffects: { retain: true }, preserveDirectEffects: true, sidestepVal: 1, rarity: '普通', desc: '触发[自然]，获得 1 层[闪避]；打出后下回合回到手牌。' },
        ...
        { poolId: 'archer_pick_feather', name: '拾羽连步', type: '能力', cost: 2, icon: '🍃', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', art: 'assets/cards/art/archer/archer_step_art_v1.webp', desc: '[回收] 1 张墓地牌；回收放逐牌时造成 7 点[流动伤害]。' },
        ...
        { poolId: 'archer_soul_return', name: '林魂招矢', type: '能力', cost: 2, icon: '🏮', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', desc: '[回收] 1 张放逐区牌到手牌；回收放逐牌时造成 7 点[流动伤害]。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_verdict_feint', name: '裁决虚锋', type: '攻击', cost: 1, icon: '⚖️', val: 4, tags: ['连击', '易伤', '销毁'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '造成 4 点伤害并施加[易伤]，随后[销毁]。' },
        { poolId: 'warrior_gap_finder', name: '窥隙烙印', type: '攻击', cost: 2, icon: '🔎', val: 7, tags: ['穿甲', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 7 点[穿甲]伤害并[抽牌]。' },
    ...
    hero_mage: [
        ...
        { poolId: 'mage_twin_spark', name: '双生火花', type: '攻击', cost: 2, icon: '🔥', val: 6, tags: ['回响'], buildTags: ['mirror', 'calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 6 点伤害，并让本牌再触发一次。' },
        ...
        { poolId: 'mage_calamity_tune', name: '厄星调律', type: '攻击', cost: 2, icon: '💠', val: 10, tags: ['诅咒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点伤害，施加[诅咒]并抽 1 张牌。' },
        ...
        { poolId: 'mage_glass_recursion', name: '镜璃递归', type: '攻击', cost: 2, icon: '💠', val: 8, tags: ['复刻', '穿甲'], buildTags: ['mirror'], rarity: '稀有', frameTheme: 'mage', desc: '造成 8 点穿甲伤害，并复制上一张非复刻牌。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_wind_string', name: '风誓扣弦', type: '能力', cost: 2, icon: '🏹', val: 8, tags: ['蓄力'], directEffects: { energy: true }, preserveDirectEffects: true, buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '获得 2 层风势并回复 1 点能量。' },
        ...
        { poolId: 'archer_green_fang', name: '青牙初矢', type: '攻击', cost: 1, icon: '☠️', val: 9, tags: ['剧毒', '销毁'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 9 点伤害，施加[剧毒]后[销毁]。' },
        { poolId: 'archer_poison_rain', name: '毒雨留痕', type: '攻击', cost: 2, icon: '🌧️', val: 11, tags: ['剧毒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 11 点伤害，施加[剧毒]并抽 1 张牌。' },
        ...
        { poolId: 'archer_pulse_burst', name: '残脉连矢', type: '攻击', cost: 2, icon: '🩸', val: 14, tags: ['放血'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 14 点伤害，触发[放血]并抽 1 张牌。' },
        ...
        { poolId: 'archer_lost_arrow_mark', name: '遗矢星标', type: '能力', cost: 2, icon: '📍', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', frameTheme: 'archer', desc: '[回收] 1 张墓地牌到手牌；回收放逐牌时造成 7 点[流动伤害]。' },
        ...
        { poolId: 'archer_empty_valley_knife', name: '空谷飞刃', type: '攻击', cost: 1, icon: '🗡️', val: 3, tags: ['销毁'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 3 点伤害后[销毁]，销毁时造成 4 点[流动伤害]。' },
        { poolId: 'archer_old_arrow_dream', name: '旧箭入梦', type: '能力', cost: 2, icon: '💤', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', frameTheme: 'archer', desc: '[回收] 1 张放逐区牌到手牌；回收放逐牌时造成 7 点[流动伤害]。' },
        ...
        { poolId: 'archer_forest_specimen', name: '归林遗羽', type: '能力', cost: 2, icon: '📦', val: 0, tags: ['回收'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['exile'], rarity: '稀有', frameTheme: 'archer', desc: '[回收] 1 张放逐区牌洗入牌库并抽 1 张牌；回收放逐牌时造成 7 点[流动伤害]。' },
        ...
        { poolId: 'archer_sky_skim', name: '掠空羽矢', type: '攻击', cost: 1, icon: '🪶', val: 3, tags: ['追击', '销毁'], buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '造成 3 点伤害，触发[追击]后[销毁]。' },
