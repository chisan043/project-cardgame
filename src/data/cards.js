...
const NEUTRAL_CARD_POOL = [
    ...
    { poolId: 'neutral_cycle', name: '星轨流转', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['重置', '销毁'], directEffects: { energy: true }, preserveDirectEffects: true, rarity: '稀有', desc: '[重置]手牌并回复 1 点能量，随后[销毁]。' },
    { poolId: 'neutral_spark', name: '碎星短刃', type: '攻击', cost: 0, icon: '✨', val: 4, tags: ['销毁'], rarity: '普通' },
    { poolId: 'neutral_bless', name: '圣像微光', type: '能力', cost: 2, icon: '🕯️', val: 10, healValue: 10, tags: ['治愈'], directEffects: { draw: true }, preserveDirectEffects: true, rarity: '普通', desc: '回复 10 点生命并抽 1 张牌。' },
...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        { poolId: 'warrior_charge', name: '誓光破阵', type: '攻击', cost: 2, icon: '✨', val: 9, tags: ['圣剑', '重击'], rarity: '稀有' },
        { poolId: 'warrior_oath', name: '遗迹立誓', type: '能力', cost: 2, icon: '📖', val: 4, tags: ['庇护', '抽牌', '保留'], rarity: '稀有', desc: '获得 4 点庇护并抽 1 张牌，打出后下回合回到手牌。' },
        ...
        { poolId: 'warrior_thorn_charge', name: '棘甲冲锋', type: '攻击', cost: 2, icon: '🌹', val: 13, tags: ['圣剑', '荆棘'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_thorn_charge_art_v1.webp', desc: '造成 13 点[圣剑]伤害并触发[荆棘]。' },
        { poolId: 'warrior_banner_guard', name: '誓旗护阵', type: '能力', cost: 2, icon: '🚩', val: 6, tags: ['庇护', '抽牌'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_banner_guard_art_v1.webp', desc: '获得 6 点庇护并抽 1 张牌。' },
        { poolId: 'warrior_blood_wall', name: '血痕引路', type: '攻击', cost: 1, icon: '🩸', val: 9, tags: ['血誓'], bloodOathCost: 4, bloodDebtBleed: 7, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '失去 4 点生命；造成 9 点伤害并施加 7 层出血。' },
        { poolId: 'warrior_oath_retainer', name: '誓约留锋', type: '防御', cost: 2, icon: '🔰', val: 6, tags: ['保留', '充能'], rarity: '普通', art: 'assets/cards/art/warrior/warrior_oath_retainer_art_v1.webp', desc: '获得 6 点护盾，[保留]并回复 1 点能量。' },
        { poolId: 'warrior_soul_oath', name: '魂誓换锋', type: '能力', cost: 2, icon: '📖', val: 4, tags: ['充能', '庇护'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_soul_oath_art_v1.webp', desc: '获得 4 点庇护并回复 1 点能量。' },
        ...
        { poolId: 'warrior_bloodlet_cleave', name: '断誓开锋', type: '攻击', cost: 1, icon: '⚔️', val: 9, tags: ['血誓'], bloodOathMissingRatio: 0.55, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 9 点伤害；追加已损生命 55% 的伤害；施加 1 层[虚弱]。' },
        ...
        { poolId: 'warrior_flaw_mark', name: '裂隙刻印', type: '能力', cost: 1, icon: '🎯', val: 0, tags: ['易伤'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['execution', 'bloodoath'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '施加[易伤]并抽 1 张牌。' },
        { poolId: 'warrior_duel_cut', name: '破甲誓斗', type: '攻击', cost: 1, icon: '🗡️', val: 13, tags: ['穿甲', '连击', '虚弱'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '造成 13 点[穿甲]伤害并施加[虚弱]；若本回合已出牌，触发[连击]。' },
        ...
        { poolId: 'warrior_blood_drive', name: '不赦血契', type: '攻击', cost: 2, icon: '🩸', val: 12, tags: ['血誓', '眩晕'], bloodOathCost: 6, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '失去 6 点生命；造成 12 点伤害并[眩晕]。' },
        { poolId: 'warrior_lifebite', name: '偿命追击', type: '攻击', cost: 1, icon: '🩸', val: 8, tags: ['吸血', '血誓'], lifestealRatio: 0.5, bloodOathMissingRatio: 0.35, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 8 点伤害；追加已损生命 35% 的伤害；施加 1 层[虚弱]；按一半伤害[吸血]。' },
        { poolId: 'warrior_blood_oath_finish', name: '血誓终击', type: '攻击', cost: 2, icon: '🩸', val: 10, tags: ['血誓', '吸血'], lifestealRatio: 0.5, bloodOathMissingRatio: 0.75, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 10 点伤害；追加已损生命 75% 的伤害；按 50% 伤害[吸血]。' }
    ],
    hero_mage: [
        ...
        { poolId: 'mage_cascade', name: '星火连祷', type: '能力', cost: 2, icon: '🪄', val: 0, tags: ['咏唱', '复刻'], directEffects: { draw: true }, rarity: '史诗', desc: '积累[咏唱]，复制上一张非复刻牌，并抽 1 张牌。' },
        ...
        { poolId: 'mage_loop', name: '法环回流', type: '能力', cost: 2, icon: '🔮', val: 0, tags: ['咏唱', '充能', '抽牌'], rarity: '稀有' },
        { poolId: 'mage_thunder', name: '裂界紫雷', type: '攻击', cost: 3, icon: '🌩️', val: 20, tags: ['爆发', '回响'], rarity: '史诗', desc: '造成 20 点[爆发]伤害，本牌再触发一次。' },
        { poolId: 'mage_star_copy', name: '星环复写', type: '能力', cost: 2, icon: '🪞', val: 0, tags: ['复刻', '咏唱'], rarity: '稀有', art: 'assets/cards/art/mage/mage_void_art_v1.webp', desc: '积累[咏唱]，并复制上一张非复刻牌。' },
        { poolId: 'mage_ember_flow', name: '燃魂导流', type: '攻击', cost: 2, icon: '🔥', val: 8, tags: ['爆发', '燃烧', '充能'], rarity: '稀有', art: 'assets/cards/art/mage/mage_ember_art_v1.webp', desc: '造成 8 点[爆发]伤害，施加[燃烧]并回复 1 点能量。' },
        { poolId: 'mage_venom_sigils', name: '厄星符阵', type: '能力', cost: 1, icon: '☠️', val: 0, tags: ['虚弱'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '普通', art: 'assets/cards/art/mage/mage_stasis_hex_art_v1.webp', desc: '施加[虚弱]并抽 1 张牌。' },
        ...
        { poolId: 'mage_bloodlet_omen', name: '断咒预兆', type: '能力', cost: 2, icon: '🌑', val: 0, tags: ['诅咒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '稀有', art: 'assets/cards/art/mage/mage_curse_echo_art_v1.webp', desc: '施加[诅咒]并抽 1 张牌。' },
        { poolId: 'mage_echo_veil', name: '回声护幕', type: '防御', cost: 2, icon: '🛡️', val: 5, tags: ['回响'], rarity: '稀有', art: 'assets/cards/art/mage/mage_barrier_art_v1.webp', desc: '获得 5 点护盾，并让本牌再触发一次。' },
        { poolId: 'mage_void_dust', name: '衰星尘', type: '攻击', cost: 2, icon: '✦', val: 12, tags: ['虚弱'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '普通', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', desc: '造成 12 点伤害，施加[虚弱]并抽 1 张牌。' },
    ...
    hero_archer: [
        { poolId: 'archer_aim', name: '风痕定弦', type: '能力', cost: 2, icon: '🎯', val: 9, tags: ['蓄力', '抽牌'], rarity: '稀有' },
        { poolId: 'archer_barrage', name: '逐风连矢', type: '攻击', cost: 1, icon: '💨', val: 7, tags: ['追击'], rarity: '稀有' },
        { poolId: 'archer_ready', name: '林风束羽', type: '能力', cost: 2, icon: '🪶', val: 8, tags: ['蓄力'], directEffects: { draw: true }, preserveDirectEffects: true, rarity: '稀有', desc: '获得 2 层风势并抽 1 张牌。' },
        { poolId: 'archer_step', name: '踏叶掠影', type: '能力', cost: 1, icon: '🥾', val: 5, tags: ['自然'], directEffects: { retain: true }, preserveDirectEffects: true, sidestepVal: 1, buildTags: ['gale', 'venom', 'exile'], rarity: '普通', desc: '触发[自然]，获得 1 层[闪避]；打出后下回合回到手牌。' },
        { poolId: 'archer_shadow', name: '狩影穿枝', type: '攻击', cost: 2, icon: '🗡️', val: 10, tags: ['追击', '穿甲'], rarity: '稀有' },
        { poolId: 'archer_grove', name: '森冠齐射', type: '攻击', cost: 2, icon: '🏹', val: 10, tags: ['追击', '穿甲'], rarity: '史诗' },
        ...
        { poolId: 'archer_blood_release', name: '赤痕裂放', type: '攻击', cost: 2, icon: '🩸', val: 15, tags: ['放血'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '稀有', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', desc: '造成 15 点伤害，触发[放血]并抽 1 张牌。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        { poolId: 'warrior_crest_guard', name: '圣徽举盾', type: '防御', cost: 1, icon: '🔰', val: 10, tags: ['庇护', '保留'], buildTags: ['oathblade'], rarity: '普通', frameTheme: 'warrior', desc: '获得 10 点护盾，触发[庇护]并[保留]。' },
        ...
        { poolId: 'warrior_rift_probe', name: '裂隙点刺', type: '攻击', cost: 0, icon: '🗡️', val: 7, tags: ['易伤', '销毁'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '造成 7 点伤害并施加[易伤]，随后[销毁]。' },
        { poolId: 'warrior_disarm_press', name: '锁腕断誓', type: '能力', cost: 0, icon: '⛓️', val: 0, tags: ['眩晕', '虚弱'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '施加[眩晕]与[虚弱]并抽 1 张牌。' },
        { poolId: 'warrior_heart_probe', name: '穿心试探', type: '攻击', cost: 1, icon: '🎯', val: 16, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 16 点[穿甲]伤害并施加[虚弱]。' },
        { poolId: 'warrior_lone_double', name: '孤锋二连', type: '攻击', cost: 2, icon: '⚔️', val: 12, tags: ['连击', '重击'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 12 点[重击]伤害；若本回合已出牌，触发[连击]。' },
        ...
        { poolId: 'warrior_steel_pressure', name: '鸣钢镇压', type: '攻击', cost: 1, icon: '🔨', val: 14, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 14 点[穿甲]伤害并施加[虚弱]。' },
        { poolId: 'warrior_execute_step', name: '断刑步', type: '能力', cost: 0, icon: '👣', val: 0, tags: ['易伤', '眩晕', '销毁'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '施加[易伤]与[眩晕]并抽 1 张牌，随后[销毁]。' },
        { poolId: 'warrior_vein_oath', name: '裂脉誓印', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['血誓'], bloodOathCost: 4, bloodDebtBleed: 7, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '失去 4 点生命并施加 7 层出血。' },
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 9, tags: ['血誓', '吸血'], lifestealRatio: 0.55, bloodOathMissingRatio: 0.4, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 9 点伤害；追加已损生命 40% 的伤害；施加 1 层[虚弱]；按 55% 伤害[吸血]。' },
        ...
        { poolId: 'warrior_blood_tide', name: '血潮续斩', type: '攻击', cost: 2, icon: '🌊', val: 12, tags: ['放血', '血誓'], bloodOathCost: 4, bloodOathMissingRatio: 0.55, bloodDebtWeak: 2, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '失去 4 点生命；造成 12 点伤害；追加已损生命 55% 的伤害；施加 2 层[虚弱]并触发[放血]。' },
        ...
        { poolId: 'warrior_life_contract', name: '回生血契', type: '能力', cost: 2, icon: '📖', val: 0, tags: ['治愈'], healValue: 10, directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '回复 10 点生命并抽 1 张牌。' },
        ...
        { poolId: 'warrior_oath_pressure', name: '誓血缚阵', type: '能力', cost: 2, icon: '🚩', val: 0, tags: ['血誓'], bloodOathCost: 4, bloodDebtStun: 1, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '失去 4 点生命并眩晕敌人。' },
        ...
        { poolId: 'warrior_devour_finish', name: '噬痕终击', type: '攻击', cost: 3, icon: '🩸', val: 14, tags: ['吸血', '血誓'], lifestealRatio: 0.5, bloodOathMissingRatio: 0.75, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 14 点伤害；追加已损生命 75% 的伤害；按 50% 伤害[吸血]。' },
        { poolId: 'warrior_oath_watch', name: '守誓待击', type: '能力', cost: 1, icon: '👁️', val: 0, tags: ['反击', '销毁'], buildTags: ['oathblade'], rarity: '普通', frameTheme: 'warrior', desc: '进入[反击]姿态，使用后[销毁]。' },
        { poolId: 'warrior_bastion_ledger', name: '垒誓残页', type: '能力', cost: 2, icon: '📒', val: 0, tags: ['庇护', '抽牌'], buildTags: ['oathblade'], rarity: '稀有', frameTheme: 'warrior', desc: '获得[庇护]并[抽牌]。' },
        { poolId: 'warrior_saintbreaker', name: '圣痕破势', type: '攻击', cost: 2, icon: '✨', val: 13, tags: ['圣剑', '易伤'], buildTags: ['oathblade', 'execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 13 点[圣剑]伤害并施加[易伤]。' },
        { poolId: 'warrior_oath_reversal', name: '誓壁反转', type: '防御', cost: 2, icon: '🔁', val: 14, tags: ['反击', '重置'], buildTags: ['oathblade'], rarity: '史诗', frameTheme: 'warrior', desc: '获得 14 点护盾，进入[反击]并[重置]手牌。' },
        { poolId: 'warrior_verdict_feint', name: '裁决虚锋', type: '攻击', cost: 0, icon: '⚖️', val: 7, tags: ['连击', '易伤', '销毁'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '造成 7 点伤害并施加[易伤]，随后[销毁]。' },
        { poolId: 'warrior_gap_finder', name: '窥隙烙印', type: '攻击', cost: 0, icon: '🔎', val: 8, tags: ['穿甲', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 8 点[穿甲]伤害并[抽牌]。' },
        { poolId: 'warrior_silent_lunge', name: '默步突刺', type: '攻击', cost: 1, icon: '🤫', val: 13, tags: ['穿甲', '眩晕'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 13 点[穿甲]伤害并[眩晕]。' },
        ...
        { poolId: 'warrior_final_measure', name: '终裁量尺', type: '攻击', cost: 2, icon: '📏', val: 20, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 20 点[穿甲][重击]伤害。' },
        { poolId: 'warrior_crimson_pause', name: '猩红喘息', type: '能力', cost: 2, icon: '🫀', val: 0, tags: ['治愈', '保留'], healValue: 8, directEffects: { draw: true, retain: true }, preserveDirectEffects: true, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '回复 8 点生命并抽 1 张牌。下回合回到手牌。' }
    ],
    hero_mage: [
        { poolId: 'mage_star_precharge', name: '星核预充', type: '能力', cost: 2, icon: '🔮', val: 0, tags: ['咏唱', '充能', '庇护'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '积累[咏唱]、回复能量并抽 1 张牌。' },
        ...
        { poolId: 'mage_solar_refill', name: '恒星回填', type: '能力', cost: 2, icon: '🌞', val: 10, tags: ['咏唱', '庇护'], directEffects: { draw: true, protection: true }, preserveDirectEffects: true, buildTags: ['chant'], rarity: '史诗', frameTheme: 'mage', desc: '积累[咏唱]、获得 10 点[庇护]并抽 1 张牌。' },
        ...
        { poolId: 'mage_twin_spark', name: '双生火花', type: '攻击', cost: 2, icon: '🔥', val: 10, tags: ['回响'], buildTags: ['mirror', 'calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点伤害，并让本牌再触发一次。' },
        ...
        { poolId: 'mage_reflect_veil', name: '倒影护幕', type: '防御', cost: 2, icon: '🛡️', val: 10, tags: ['回响'], buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '获得 10 点护盾，并让本牌再触发一次。' },
        ...
        { poolId: 'mage_aftertone_flow', name: '余音导流', type: '能力', cost: 1, icon: '🎼', val: 6, tags: ['充能', '庇护'], buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '获得 6 点[庇护]并回复 1 点能量。' },
        ...
        { poolId: 'mage_transcribe_ring', name: '抄录星环', type: '能力', cost: 2, icon: '🔮', val: 0, tags: ['复刻'], directEffects: { energy: true }, buildTags: ['mirror'], rarity: '稀有', frameTheme: 'mage', desc: '复制上一张非复刻牌，并回复 1 点能量。' },
        { poolId: 'mage_double_archive', name: '双页归档', type: '能力', cost: 2, icon: '📚', val: 0, tags: ['复刻'], buildTags: ['mirror'], rarity: '史诗', frameTheme: 'mage', desc: '复制上一张非复刻牌。' },
        { poolId: 'mage_corrupt_mist', name: '蚀星雾', type: '能力', cost: 2, icon: '☠️', val: 0, tags: ['诅咒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '普通', frameTheme: 'mage', desc: '施加[诅咒]并抽 1 张牌。' },
        { poolId: 'mage_frost_hex', name: '霜咒压迫', type: '攻击', cost: 1, icon: '🌑', val: 10, tags: ['虚弱', '诅咒'], buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点伤害，施加[虚弱]与[诅咒]。' },
        { poolId: 'mage_sick_star', name: '坠星病灶', type: '攻击', cost: 1, icon: '☄️', val: 10, tags: ['易伤'], buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点伤害并施加[易伤]。' },
        ...
        { poolId: 'mage_bad_omen_chain', name: '厄兆连珠', type: '攻击', cost: 1, icon: '🔥', val: 10, tags: ['燃烧', '虚弱'], buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点伤害，施加[燃烧]与[虚弱]。' },
        ...
        { poolId: 'mage_withered_stars', name: '群星枯萎', type: '攻击', cost: 2, icon: '✦', val: 15, tags: ['诅咒', '虚弱'], buildTags: ['calamity'], rarity: '史诗', frameTheme: 'mage', desc: '造成 15 点伤害，施加[诅咒]与[虚弱]。' },
        { poolId: 'mage_calamity_tune', name: '厄星调律', type: '攻击', cost: 2, icon: '💠', val: 16, tags: ['诅咒'], directEffects: { draw: true, protection: true }, protectVal: 6, preserveDirectEffects: true, buildTags: ['calamity'], rarity: '稀有', frameTheme: 'mage', desc: '造成 16 点伤害，施加[诅咒]，抽 1 并获得 6 点[庇护]。' },
        { poolId: 'mage_lantern_chant', name: '灯火续咏', type: '能力', cost: 1, icon: '🏮', val: 8, tags: ['咏唱', '庇护'], buildTags: ['chant'], rarity: '普通', frameTheme: 'mage', desc: '积累[咏唱]并获得 8 点[庇护]。' },
        ...
        { poolId: 'mage_reflection_note', name: '倒影批注', type: '能力', cost: 1, icon: '📝', val: 0, tags: ['复刻', '销毁'], buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '复制上一张非复刻牌，打出后销毁。' },
        { poolId: 'mage_echo_index', name: '回声页标', type: '能力', cost: 1, icon: '🔖', val: 5, tags: ['抽牌', '庇护'], buildTags: ['mirror'], rarity: '普通', frameTheme: 'mage', desc: '抽 1 张牌并获得 5 点[庇护]。' },
        { poolId: 'mage_glass_recursion', name: '镜璃递归', type: '攻击', cost: 2, icon: '💠', val: 10, tags: ['复刻', '穿甲'], buildTags: ['mirror'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点穿甲伤害，并复制上一张非复刻牌。' },
        { poolId: 'mage_second_hand', name: '逆时针护刻', type: '防御', cost: 2, icon: '🕰️', val: 8, tags: ['回响'], buildTags: ['mirror'], rarity: '史诗', frameTheme: 'mage', desc: '获得 8 点护盾，并让本牌再触发一次。' }
    ],
    hero_archer: [
        { poolId: 'archer_leaf_sidestep', name: '踏叶侧射', type: '攻击', cost: 1, icon: '🍃', val: 9, tags: ['追击', '自然'], buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '造成 9 点伤害，触发[追击]与[自然]。' },
        ...
        { poolId: 'archer_backstep', name: '回风掠步', type: '防御', cost: 2, icon: '🪶', val: 14, tags: ['自然', '重置'], buildTags: ['gale'], rarity: '稀有', frameTheme: 'archer', desc: '获得 14 点护盾，触发[自然]并[重置]手牌。' },
        { poolId: 'archer_quick_corridor', name: '急羽破廊', type: '攻击', cost: 2, icon: '💨', val: 15, tags: ['追击', '穿甲'], buildTags: ['gale'], rarity: '稀有', frameTheme: 'archer', desc: '造成 15 点[穿甲]伤害，附带[追击]。' },
        { poolId: 'archer_green_fang', name: '青牙初矢', type: '攻击', cost: 1, icon: '☠️', val: 10, tags: ['剧毒', '销毁'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 10 点伤害，施加[剧毒]后[销毁]。' },
        { poolId: 'archer_poison_rain', name: '毒雨留痕', type: '攻击', cost: 2, icon: '🌧️', val: 13, tags: ['剧毒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 13 点伤害，施加[剧毒]并抽 1 张牌。' },
        { poolId: 'archer_hook_sinew', name: '裂筋倒钩', type: '攻击', cost: 1, icon: '🪝', val: 11, tags: ['放血', '虚弱'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 11 点伤害，触发[放血]并施加[虚弱]。' },
        { poolId: 'archer_spore_shadow', name: '孢影伏击', type: '能力', cost: 1, icon: '🍄', val: 0, tags: ['剧毒'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '施加[剧毒]并抽 1 张牌。' },
        ...
        { poolId: 'archer_snake_eye', name: '蛇瞳烙印', type: '能力', cost: 1, icon: '🐍', val: 0, tags: ['易伤'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '施加[易伤]并抽 1 张牌。' },
        { poolId: 'archer_red_tide_bow', name: '赤潮弦', type: '攻击', cost: 1, icon: '🏹', val: 10, tags: ['出血'], buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 10 点伤害并施加[出血]。' },
        ...
        { poolId: 'archer_pulse_burst', name: '残脉连矢', type: '攻击', cost: 2, icon: '🩸', val: 16, tags: ['放血'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '造成 16 点伤害，触发[放血]并抽 1 张牌。' },
        ...
        { poolId: 'archer_rotten_net', name: '腐叶陷网', type: '能力', cost: 2, icon: '🕸️', val: 0, tags: ['剧毒', '眩晕'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '史诗', frameTheme: 'archer', desc: '施加[剧毒]、[眩晕]并抽 1 张牌。' },
        ...
        { poolId: 'archer_bitter_vine', name: '苦藤攀附', type: '能力', cost: 2, icon: '🌿', val: 0, tags: ['剧毒', '充能'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '施加[剧毒]、回复能量并抽 1 张牌。' },
        ...
        { poolId: 'archer_green_mist_end', name: '绿雾终幕', type: '攻击', cost: 2, icon: '☠️', val: 22, tags: ['剧毒', '放血', '虚弱'], buildTags: ['venom'], rarity: '史诗', frameTheme: 'archer', desc: '造成 22 点伤害，施加[剧毒]与[虚弱]并触发[放血]。' },
        ...
        { poolId: 'archer_empty_string', name: '空弦匿羽', type: '能力', cost: 1, icon: '🏹', val: 0, tags: ['放逐'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '自身[放逐]并抽 1 张牌，进入放逐区时造成 5 点[流动伤害]。' },
        { poolId: 'archer_outerwood_recall', name: '林外归魂', type: '能力', cost: 1, icon: '🏮', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', frameTheme: 'archer', desc: '[回收] 1 张放逐区牌到手牌；回收放逐牌时造成 7 点[流动伤害]。' },
        { poolId: 'archer_deadbranch_shuffle', name: '残枝回轮', type: '能力', cost: 2, icon: '🧭', val: 0, tags: ['回收', '蓄力'], directEffects: { energy: true }, preserveDirectEffects: true, buildTags: ['exile', 'gale'], rarity: '史诗', frameTheme: 'archer', desc: '获得风势并回复 1 点能量；[回收] 1 张放逐区牌洗入牌库。' },
        ...
        { poolId: 'archer_leaf_store', name: '飞叶封存', type: '防御', cost: 1, icon: '🍂', val: 9, tags: ['闪避', '保留'], buildTags: ['gale', 'venom', 'exile'], rarity: '普通', frameTheme: 'archer', desc: '获得 9 点护盾，获得 1 层[闪避]并[保留]。' },
        { poolId: 'archer_nest_track', name: '归巢血轨', type: '攻击', cost: 2, icon: '🧭', val: 16, tags: ['回收', '出血'], buildTags: ['exile', 'venom'], rarity: '史诗', frameTheme: 'archer', desc: '造成 16 点伤害，施加[出血]，并[回收] 1 张放逐区牌洗入牌库；回收放逐牌时造成 7 点[流动伤害]。' },
        { poolId: 'archer_empty_valley_knife', name: '空谷飞刃', type: '攻击', cost: 1, icon: '🗡️', val: 5, tags: ['销毁'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 5 点伤害后[销毁]，销毁时造成 4 点[流动伤害]。' },
        ...
        { poolId: 'archer_leaf_search', name: '叶脉寻踪', type: '能力', cost: 1, icon: '🔎', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '稀有', frameTheme: 'archer', desc: '[回收] 1 张墓地牌到手牌；回收放逐牌时造成 7 点[流动伤害]。' },
        ...
        { poolId: 'archer_leaf_reload', name: '叶脉换弦', type: '能力', cost: 1, icon: '🍃', val: 4, tags: ['蓄力'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '获得 1 层风势并抽 1 张牌。' },
        { poolId: 'archer_sky_skim', name: '掠空羽矢', type: '攻击', cost: 1, icon: '🪶', val: 8, tags: ['追击', '销毁'], buildTags: ['gale'], rarity: '普通', frameTheme: 'archer', desc: '造成 8 点伤害，触发[追击]后[销毁]。' },
        { poolId: 'archer_crosswind_guard', name: '侧风护步', type: '防御', cost: 1, icon: '🥾', val: 11, tags: ['自然', '保留'], buildTags: ['gale', 'venom', 'exile'], rarity: '稀有', frameTheme: 'archer', desc: '获得 11 点护盾，触发[自然]并[保留]。' },
        { poolId: 'archer_lostroad_cache', name: '失路羽囊', type: '能力', cost: 2, icon: '📦', val: 0, tags: ['放逐'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '自身[放逐]并抽 1 张牌，进入放逐区时造成 5 点[流动伤害]。' }
    ],
    neutral: [
        { poolId: 'neutral_blank_pact', name: '空白契约', type: '能力', cost: 1, icon: '📄', val: 0, tags: ['抽牌', '销毁'], rarity: '普通', desc: '[抽牌]后[销毁]。' },
        { poolId: 'neutral_cold_iron_page', name: '冷铁护页', type: '防御', cost: 1, icon: '📘', val: 7, tags: ['庇护'], rarity: '普通', desc: '获得 7 点护盾并触发[庇护]。' },
        { poolId: 'neutral_ash_marker', name: '灰烬路标', type: '能力', cost: 1, icon: '🔥', val: 0, tags: ['易伤', '抽牌'], rarity: '稀有', desc: '施加[易伤]并[抽牌]。' }
    ]
};
...
const STARTER_DECKS = {
    ...
    starter_archer: {
        ...
        cards: [
            ...
            { poolId: 'starter_archer_step', name: '林隙闪步', type: '能力', cost: 2, icon: '🍃', val: 1, tags: ['闪避'], buildNeutral: true, sidestepVal: 1, rarity: '普通', copies: 2, frameTheme: 'archer', desc: '获得 1 层[闪避]，完全躲开本轮敌方主体的下一段攻击。' },
            { poolId: 'starter_archer_aim', name: '风痕定弦', type: '能力', cost: 2, icon: '🎯', val: 4, tags: ['蓄力'], buildTags: ['gale'], directEffects: { draw: true }, rarity: '普通', copies: 2, frameTheme: 'archer', desc: '获得风势并抽 1 张牌。' },
            { poolId: 'starter_archer_exile', name: '逐影离弦', type: '攻击', cost: 2, icon: '🏹', val: 10, tags: ['放逐'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 10 点伤害并[放逐]；进入放逐区时造成 5 点[流动伤害]。' },
            { poolId: 'starter_archer_focus', name: '旅箭整束', type: '能力', cost: 1, icon: '🪶', val: 0, tags: [], buildNeutral: true, directEffects: { draw: true }, rarity: '普通', frameTheme: 'archer', desc: '抽 1 张牌。' }
        ]
    }
};
