...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_wall', name: '血痕引路', type: '攻击', cost: 1, icon: '🩸', val: 9, tags: ['血誓'], bloodOathCost: 5, bloodDebtBleed: 6, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '失去 5 点生命；造成 9 点伤害并施加 6 层出血。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 8, tags: ['血誓', '吸血'], lifestealRatio: 0.5, bloodOathMissingRatio: 0.4, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 8 点伤害；追加已损生命 40% 的伤害；施加 1 层[虚弱]；按一半伤害[吸血]。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_poison_step', name: '毒荆护步', type: '防御', cost: 1, icon: '🥾', val: 16, tags: ['虚弱'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '获得 16 点护盾并施加[虚弱]。' },
