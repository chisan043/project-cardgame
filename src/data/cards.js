...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_vow_slash', name: '血誓斩', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['血债'], bloodDebtGain: 3, bloodDebtDamageRatio: 1, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '获得 3 点[血债]。造成 7 点伤害，并追加等同当前血债的伤害。' },
        ...
        { poolId: 'warrior_bloodlet_cleave', name: '断誓开锋', type: '攻击', cost: 1, icon: '⚔️', val: 7, tags: ['放血'], bloodDebtDamageRatio: 0.75, bloodDebtRepayFromBleed: 0.5, bloodDebtClearDamage: 6, bloodDebtClearHeal: 3, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 7 点伤害并追加当前血债 75% 的伤害，再触发[放血]。按放血伤害的 50% 偿债；完全清偿时追加 6 点伤害并回复 3 点生命。' },
        ...
        { poolId: 'warrior_frenzy_cleave', name: '狂誓裂斩', type: '攻击', cost: 2, icon: '🔥', val: 7, tags: ['狂热', '重击'], buildTags: ['execution'], rarity: '史诗', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', desc: '丢弃 1 张手牌获得[狂热]，随后以[重击]打出高压斩击。' },
        ...
        { poolId: 'warrior_blood_drive', name: '不赦血契', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['血债'], bloodDebtGain: 8, bloodDebtPowerGain: 0.5, bloodDebtSettlementMultiplier: 2, bloodDebtStun: 1, drawCount: 2, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '获得 8 点[血债]、眩晕敌人并抽 2 张牌。本回合血债伤害倍率 +50%，但未偿血债的清算伤害翻倍。' },
        { poolId: 'warrior_lifebite', name: '偿命追击', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['吸血'], lifestealRatio: 1, bloodDebtDamageRatio: 0.75, bloodDebtClearDamage: 7, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 7 点伤害并追加当前血债 75% 的伤害，以全部伤害[吸血]。若完全清偿血债，追加 7 点伤害。' },
        { poolId: 'warrior_blood_debt', name: '血债清算', type: '攻击', cost: 2, icon: '🩸', val: 10, tags: ['血债', '吸血'], bloodDebtDamageRatio: 2, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 10 点伤害，并追加当前血债两倍的伤害，随后[吸血]偿债。' }
    ],
    hero_mage: [
...
const BUILD_DIRECTIONS = {
    hero_warrior: {
        ...
        bloodoath: { name: '血誓狂战', desc: '借入血债放大攻势，再用吸血与放血在回合结束前完成清偿。', triggerTags: ['血债', '吸血', '出血', '放血'] }
    },
    hero_mage: {
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_lone_double', name: '孤锋二连', type: '攻击', cost: 2, icon: '⚔️', val: 6, tags: ['连击', '重击'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '先出别的牌后再用它，[连击]与[重击]共同放大这次收束。' },
        ...
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 6, tags: ['血债'], bloodDebtDamageRatio: 0.75, bloodDebtRepay: 4, bloodDebtClearDamage: 6, bloodDebtClearHeal: 4, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 6 点伤害并追加当前血债 75% 的伤害，再偿还 4 点血债；完全清偿时追加 6 点伤害并回复 4 点生命。' },
        { poolId: 'warrior_boiling_drive', name: '沸血突进', type: '攻击', cost: 1, icon: '🔥', val: 6, tags: ['血债'], bloodDebtGain: 3, bloodDebtDamageRatio: 1.5, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '获得 3 点[血债]。造成 6 点伤害，并追加当前血债 150% 的伤害。' },
        { poolId: 'warrior_red_return', name: '残红回锋', type: '攻击', cost: 1, icon: '💍', val: 6, tags: ['吸血', '保留'], lifestealRatio: 1, bloodDebtDamageRatio: 0.75, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '造成 6 点伤害并追加当前血债 75% 的伤害，以全部伤害[吸血]；打出后下回合回到手牌。' },
        { poolId: 'warrior_blood_tide', name: '血潮续斩', type: '攻击', cost: 2, icon: '🌊', val: 9, tags: ['放血', '血债'], bloodDebtDamageRatio: 1.25, bloodDebtRepayFromBleed: 0.75, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 9 点伤害并追加当前血债 125% 的伤害。触发[放血]，按放血伤害的 75% 偿债。' },
