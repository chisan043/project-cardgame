...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_bleed_edge', name: '誓血裂口', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['血债'], bloodDebtGain: 2, bloodDebtBleed: 4, buildTags: ['bloodoath'], rarity: '普通', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '获得 2 点[血债]，造成 7 点伤害并施加 4 层出血。' },
        { poolId: 'warrior_bloodlet_cleave', name: '断誓开锋', type: '攻击', cost: 1, icon: '⚔️', val: 9, tags: ['血债'], bloodDebtDamageRatio: 1.25, bloodDebtRepay: 5, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 9 点伤害，追加当前血债 125% 的伤害，并偿还 5 点血债。' },
        ...
        { poolId: 'warrior_lifebite', name: '偿命追击', type: '攻击', cost: 1, icon: '🩸', val: 9, tags: ['吸血'], lifestealRatio: 1, bloodDebtDamageRatio: 1.25, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 9 点伤害，追加当前血债 125% 的伤害，并以全部伤害[吸血]。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_crimson_pause', name: '猩红喘息', type: '能力', cost: 1, icon: '🫀', val: 0, tags: ['血债', '保留'], bloodDebtRepay: 7, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '偿还 7 点血债。打出后下回合回到手牌。' }
    ],
    hero_mage: [
