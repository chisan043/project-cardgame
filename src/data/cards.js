...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_blood_vow_slash', name: '血誓斩', type: '攻击', cost: 1, icon: '🩸', val: 8, tags: ['血债'], bloodDebtGain: 3, bloodDebtDamageRatio: 1.25, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '获得 3 点[血债]。造成 8 点伤害，并追加当前血债 125% 的伤害。' },
        ...
        { poolId: 'warrior_blood_wall', name: '血痕引路', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['血债'], bloodDebtGain: 2, bloodDebtBleed: 4, bloodDebtWeak: 1, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '获得 2 点[血债]，施加 4 层出血、1 层虚弱并抽 1 张牌。' },
        ...
        { poolId: 'warrior_bleed_edge', name: '誓血裂口', type: '攻击', cost: 1, icon: '🩸', val: 6, tags: ['血债'], bloodDebtGain: 2, bloodDebtBleed: 3, buildTags: ['bloodoath'], rarity: '普通', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '获得 2 点[血债]，造成 6 点伤害并施加 3 层出血。' },
        { poolId: 'warrior_bloodlet_cleave', name: '断誓开锋', type: '攻击', cost: 1, icon: '⚔️', val: 8, tags: ['放血'], bloodDebtDamageRatio: 1, bloodDebtRepayFromBleed: 0.5, bloodDebtClearDamage: 8, bloodDebtClearHeal: 3, buildTags: ['bloodoath'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 8 点伤害，追加血债 100% 并[放血]。放血伤害 50% 偿债；清债时 +8 伤害并回 3 生命。' },
        { poolId: 'warrior_venom_scar', name: '破势剑痕', type: '攻击', cost: 1, icon: '☠️', val: 7, tags: ['易伤', '穿甲'], buildTags: ['execution'], rarity: '稀有', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '造成 7 点[穿甲]伤害并施加[易伤]。为后续处刑攻击打开缺口。' },
        ...
        { poolId: 'warrior_duel_cut', name: '断甲决斗', type: '攻击', cost: 1, icon: '🗡️', val: 9, tags: ['穿甲', '连击'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '造成 9 点伤害。若本回合已打出过其他牌，[连击]会提高伤害，并且[穿甲]无视护甲。' },
        ...
        { poolId: 'warrior_blood_drive', name: '不赦血契', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['血债'], bloodDebtGain: 8, bloodDebtPowerGain: 0.5, bloodDebtStun: 1, drawCount: 2, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', desc: '获得 8 点[血债]、眩晕敌人并抽 2 张牌。本回合血债伤害倍率 +50%。' },
        { poolId: 'warrior_lifebite', name: '偿命追击', type: '攻击', cost: 1, icon: '🩸', val: 8, tags: ['吸血'], lifestealRatio: 1, bloodDebtDamageRatio: 1, bloodDebtClearDamage: 9, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 8 点伤害，追加血债 100%，并以全部伤害[吸血]；清债时 +9 伤害。' },
        { poolId: 'warrior_blood_debt', name: '血债清算', type: '攻击', cost: 2, icon: '🩸', val: 12, tags: ['血债', '吸血'], bloodDebtDamageRatio: 2.25, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', desc: '造成 12 点伤害，并追加当前血债 225% 的伤害，随后[吸血]偿债。' }
    ],
    hero_mage: [
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_break_form', name: '破阵换位', type: '能力', cost: 0, icon: '🚩', val: 0, tags: ['重置', '销毁'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '选择任意张手牌丢弃并抽取等量的牌，随后[销毁]。' },
        ...
        { poolId: 'warrior_vein_oath', name: '裂脉誓印', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['血债'], bloodDebtGain: 4, bloodDebtBleed: 5, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '获得 4 点[血债]并施加 5 层出血与 1 层虚弱。' },
        { poolId: 'warrior_blood_guard_step', name: '偿血追命', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['血债'], bloodDebtDamageRatio: 1, bloodDebtRepay: 5, bloodDebtClearDamage: 8, bloodDebtClearHeal: 4, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 7 点伤害，追加血债 100%，偿还 5 血债；清债时 +8 伤害并回 4 生命。' },
        { poolId: 'warrior_boiling_drive', name: '沸血突进', type: '攻击', cost: 1, icon: '🔥', val: 7, tags: ['血债'], bloodDebtGain: 3, bloodDebtDamageRatio: 1.75, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '获得 3 点[血债]。造成 7 点伤害，并追加当前血债 175% 的伤害。' },
        { poolId: 'warrior_red_return', name: '残红回锋', type: '攻击', cost: 1, icon: '💍', val: 6, tags: ['吸血', '保留'], lifestealRatio: 1, bloodDebtDamageRatio: 0.75, buildTags: ['bloodoath'], rarity: '普通', frameTheme: 'warrior', desc: '造成 6 点伤害，追加血债 75%，全额[吸血]；下回合回手。' },
        { poolId: 'warrior_blood_tide', name: '血潮续斩', type: '攻击', cost: 2, icon: '🌊', val: 11, tags: ['放血', '血债'], bloodDebtDamageRatio: 1.5, bloodDebtRepayFromBleed: 0.75, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 11 点伤害，追加血债 150%；[放血]伤害 75% 偿债。' },
        ...
        { poolId: 'warrior_life_contract', name: '回生血契', type: '能力', cost: 1, icon: '📖', val: 0, tags: ['血债'], bloodDebtRepay: 6, bloodDebtWeak: 1, drawCount: 1, directEffects: { draw: true }, bloodDebtDrawOnRepay: 1, bloodDebtClearHeal: 4, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '偿还 6 血债，施加 1 虚弱并抽 1；若偿债再抽 1；清债时回 4 生命。' },
        ...
        { poolId: 'warrior_oath_pressure', name: '誓血缚阵', type: '能力', cost: 1, icon: '🚩', val: 0, tags: ['血债'], bloodDebtGain: 3, bloodDebtWeak: 2, bloodDebtStun: 1, buildTags: ['bloodoath'], rarity: '稀有', frameTheme: 'warrior', desc: '获得 3 点[血债]，施加 2 层虚弱并眩晕敌人，用控制换取清债时间。' },
        ...
        { poolId: 'warrior_devour_finish', name: '噬痕终击', type: '攻击', cost: 3, icon: '🩸', val: 18, tags: ['放血', '吸血'], bloodDebtDamageRatio: 2.25, bloodDebtRepayFromBleed: 1, buildTags: ['bloodoath'], rarity: '史诗', frameTheme: 'warrior', desc: '造成 18 点伤害，追加血债 225%；[放血]后[吸血]，两段均可偿债。' },
