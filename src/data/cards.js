...
const BUILD_EXPANSION_CARDS = {
    ...
    hero_archer: [
        ...
        { poolId: 'archer_pulse_burst', name: '残脉连扣', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['放血'], directEffects: { draw: true }, preserveDirectEffects: true, buildTags: ['venom'], rarity: '普通', frameTheme: 'archer', desc: '触发[放血]后抽 1 张牌。' },
