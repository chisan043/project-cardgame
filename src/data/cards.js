...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_heart_probe', name: '穿心试探', type: '攻击', cost: 1, icon: '🎯', val: 14, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 14 点[穿甲]伤害并施加[虚弱]。' },
        ...
        { poolId: 'warrior_steel_pressure', name: '鸣钢镇压', type: '攻击', cost: 1, icon: '🔨', val: 12, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 12 点[穿甲]伤害并施加[虚弱]。' },
        ...
        { poolId: 'warrior_silent_lunge', name: '默步突刺', type: '攻击', cost: 1, icon: '🤫', val: 11, tags: ['穿甲', '眩晕'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 11 点[穿甲]伤害并[眩晕]。' },
