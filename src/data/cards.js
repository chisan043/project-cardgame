...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_venom_scar', name: '破势剑痕', type: '攻击', cost: 1, icon: '☠️', val: 6, tags: ['易伤', '穿甲'], buildTags: ['execution'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_裂光一闪.webp', desc: '造成 6 点穿甲伤害并施加[易伤]。为后续处刑攻击打开缺口。' },
        ...
        { poolId: 'warrior_exile_judgement', name: '终誓处刑', type: '攻击', cost: 2, icon: '⚔️', val: 16, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/勇者战士_终誓裁断.webp', desc: '造成 16 点穿甲伤害，附带[重击]。不吃护盾收益，专注于直接斩杀。' },
    ...
    hero_mage: [
        ...
        { poolId: 'mage_exile_nova', name: '裂星禁术', type: '攻击', cost: 2, icon: '🌌', val: 15, tags: ['爆发', '穿甲', '放逐'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/萝莉魔导士_裂界紫雷.webp', desc: '造成 15 点穿甲伤害，附带[爆发]与[放逐]。' }
    ],
    hero_archer: [
        ...
        { poolId: 'archer_exile_shot', name: '逐影放矢', type: '攻击', cost: 1, icon: '🏹', val: 8, tags: ['放逐', '穿甲'], buildTags: ['exile'], rarity: '稀有', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_狩影穿枝.webp', desc: '造成 8 点穿甲伤害并[放逐]。' },
        ...
        { poolId: 'archer_exile_storm', name: '逐风绝矢', type: '攻击', cost: 2, icon: '💨', val: 12, tags: ['放逐', '穿甲', '多段'], buildTags: ['exile'], rarity: '史诗', art: '卡牌设计/教堂彩窗赛璐璐/卡面插画_无框/精灵弓箭手_回环箭雨.webp', desc: '造成 12 点穿甲伤害，附带[放逐]与[多段]。' }
    ]
};
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_disarm_press', name: '断腕缴械', type: '能力', cost: 1, icon: '⛓️', val: 0, tags: ['眩晕', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '施加[眩晕]并[抽牌]。用控制回合换取下一次穿甲斩。' },
        { poolId: 'warrior_heart_probe', name: '穿心试探', type: '攻击', cost: 1, icon: '🎯', val: 6, tags: ['穿甲', '易伤'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', desc: '造成穿甲伤害并施加[易伤]，是处刑线的轻量起手。' },
        ...
        { poolId: 'warrior_steel_pressure', name: '鸣钢压迫', type: '攻击', cost: 2, icon: '🔨', val: 10, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '穿甲攻击并施加[虚弱]。适合在不能立刻斩杀时压低反击风险。' },
        ...
        { poolId: 'warrior_gap_finder', name: '破隙检定', type: '攻击', cost: 1, icon: '🔎', val: 5, tags: ['穿甲', '抽牌'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 5 点穿甲伤害并[抽牌]。' },
        { poolId: 'warrior_silent_lunge', name: '默步突刺', type: '攻击', cost: 1, icon: '🤫', val: 7, tags: ['穿甲', '眩晕'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '穿甲攻击并[眩晕]，用一拍停顿换下一回合的斩杀空间。' },
        ...
        { poolId: 'warrior_final_measure', name: '终裁量尺', type: '攻击', cost: 2, icon: '📏', val: 12, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', desc: '稳定的穿甲重击收束牌，适合在易伤窗口已经打开后直接下判。' },
    ...
    hero_mage: [
        ...
        { poolId: 'mage_radiant_law', name: '辉烬爆律', type: '攻击', cost: 2, icon: '🔥', val: 10, tags: ['爆发', '穿甲'], buildTags: ['chant'], rarity: '稀有', frameTheme: 'mage', desc: '造成 10 点穿甲伤害，附带[爆发]。' },
        ...
        { poolId: 'mage_copy_pierce', name: '复写残响', type: '攻击', cost: 2, icon: '🌩️', val: 11, tags: ['回响', '穿甲'], buildTags: ['mirror'], rarity: '史诗', frameTheme: 'mage', desc: '造成 11 点穿甲伤害，附带[回响]。' },
        ...
        { poolId: 'mage_glass_recursion', name: '玻璃递归', type: '攻击', cost: 1, icon: '💠', val: 5, tags: ['复刻', '穿甲'], buildTags: ['mirror'], rarity: '稀有', frameTheme: 'mage', desc: '造成 5 点穿甲伤害，触发[复刻]。' },
    ...
    hero_archer: [
        ...
        { poolId: 'archer_quick_corridor', name: '急羽穿廊', type: '攻击', cost: 2, icon: '💨', val: 9, tags: ['连射', '穿甲'], buildTags: ['gale'], rarity: '稀有', frameTheme: 'archer', desc: '造成 9 点穿甲伤害，附带[连射]。' },
        ...
        { poolId: 'archer_throat_poison', name: '森毒封喉', type: '攻击', cost: 2, icon: '☠️', val: 9, tags: ['剧毒', '穿甲'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 9 点穿甲伤害并施加[剧毒]。' },
        ...
        { poolId: 'archer_skin_splitter', name: '裂肤箭', type: '攻击', cost: 1, icon: '🩸', val: 7, tags: ['出血', '穿甲'], buildTags: ['venom'], rarity: '稀有', frameTheme: 'archer', desc: '造成 7 点穿甲伤害并施加[出血]。' },
        ...
        { poolId: 'archer_shadow_line', name: '影羽切线', type: '攻击', cost: 1, icon: '🗡️', val: 8, tags: ['放逐', '穿甲'], buildTags: ['exile'], rarity: '普通', frameTheme: 'archer', desc: '造成 8 点穿甲伤害并[放逐]。' },
        ...
        { poolId: 'archer_nest_track', name: '回巢轨迹', type: '攻击', cost: 2, icon: '🧭', val: 10, tags: ['轮回', '穿甲'], buildTags: ['exile'], rarity: '稀有', frameTheme: 'archer', desc: '造成 10 点穿甲伤害并触发[轮回]。' },
