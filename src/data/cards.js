...
const CHARACTER_CARD_POOLS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_release', name: '誓刃解封', type: '攻击', cost: 3, icon: '⚔️', val: 14, tags: ['圣剑', '重击'], buildTags: ['oathblade'], rarity: '史诗', desc: '造成 14 点伤害。将护盾与蓄势集中到一次[圣剑][重击]中。' },
        ...
        { poolId: 'warrior_duel_cut', name: '破甲誓斗', type: '攻击', cost: 1, icon: '🗡️', val: 12, tags: ['穿甲', '连击', '虚弱'], buildTags: ['execution'], rarity: '普通', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', desc: '造成 12 点伤害并施加[虚弱]。若本回合已打出过其他牌，[连击]会提高伤害，并且[穿甲]无视护甲。' },
        { poolId: 'warrior_execute_window', name: '断首星隙', type: '攻击', cost: 2, icon: '⚔️', val: 15, tags: ['易伤', '重击'], buildTags: ['execution'], rarity: '史诗', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', desc: '造成 15 点伤害并施加[易伤]。附带[重击]，适合作为处刑连斩的收束牌。' },
...
const BUILD_EXPANSION_CARDS = {
    hero_warrior: [
        ...
        { poolId: 'warrior_steel_pressure', name: '鸣钢镇压', type: '攻击', cost: 2, icon: '🔨', val: 14, tags: ['穿甲', '虚弱'], buildTags: ['execution'], rarity: '稀有', frameTheme: 'warrior', desc: '造成 14 点[穿甲]伤害并施加[虚弱]。适合在不能立刻斩杀时压低反击风险。' },
        ...
        { poolId: 'warrior_bastion_ledger', name: '垒誓残页', type: '能力', cost: 1, icon: '📒', val: 0, tags: ['庇护', '抽牌'], buildTags: ['oathblade'], rarity: '稀有', frameTheme: 'warrior', desc: '获得[庇护]并[抽牌]，不是继续堆大盾，而是把守势转换成下一张圣剑选择。' },
