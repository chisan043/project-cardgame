...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 64, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 64 点[穿甲]；每层[易伤]追加 10 伤害；手牌每张[连击]/[穿甲]追加 6 伤害。' }
    ],
    hero_mage: [
    ...
    hero_archer: [
        ...
        { id: 's_poison', name: '青毒终绽', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 2, icon: '💥', val: 20, tags: ['剧毒', '出血'], rarity: '史诗', isSpecial: true, desc: '造成 20 真实伤害；再按剧毒与出血总层数造成 2 倍伤害，不清层。按总层数获得至多 12 庇护。' },
        ...
        { id: 'a_gale_verdict', name: '风冠裁矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 14, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 14 点[穿甲]；消耗至多 3 层风势，每层追加 8 伤害并获得 2 庇护。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    ...
    hero_mage: [
        ...
        { id: 'm_mirror_hallway', name: '折廊回声', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 2, icon: '🏛️', val: 0, tags: ['回响', '保留'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌，并使下一次伤害提高 8；回响时再次提高 8。打出后下回合回到手牌。' },
        { id: 'm_mirror_glassbolt', name: '镜棱短雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '💠', val: 8, tags: ['回响', '穿甲'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '造成 8 点穿甲伤害，并让本牌再触发一次。' },
    ...
    hero_archer: [
        ...
        { id: 'a_gale_splinter', name: '碎风齐射', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 1, icon: '💨', val: 7, tags: ['追击'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 7 点伤害并触发[追击]。' },
        ...
        { id: 'a_gale_featherbank', name: '百羽开匣', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '🏹', val: 9, tags: ['追击', '抽牌'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 9 点伤害，触发[追击]并[抽牌]。' },
