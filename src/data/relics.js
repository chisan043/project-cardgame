...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 'm_status_supernova', name: '万象超新星', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 38, tags: ['爆发', '燃烧'], rarity: '史诗', isSpecial: true, desc: '造成 38 点伤害。敌方每种负面状态追加 10 伤害并获得 5 点庇护，随后施加最多 3 层[燃烧]。' },
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌，抽 1，并获得 2 庇护；对首领追加 4% 最大生命。无目标时积累 3 层[咏唱]并抽 2。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 52, tags: ['爆发', '销毁', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 52 点[穿甲]后[销毁]。对首领追加 60% 最大生命伤害；每层[咏唱]追加 18 伤害并获得 4 庇护。' },
