...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 52, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 52 点[穿甲]。每层[易伤]追加 12 伤害，手牌每张[连击]/[穿甲]追加 16 伤害；若敌人未倒下，施加 4 层[虚弱]。' }
    ],
    hero_mage: [
        ...
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌，抽 1，获得 8 庇护，并使下一次伤害提高 10。无目标时积累 3 层[咏唱]并抽 2。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 60, tags: ['爆发', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 60 点[穿甲]。每层[咏唱]追加 28 伤害并获得 8 庇护；若消耗至少 6 层咏唱，施加 1 层[眩晕]。' },
    ...
    hero_archer: [
        { id: 's_exhaust', name: '风葬归矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '能力', cost: 3, icon: '🕳️', val: 0, tags: ['放逐', '回收'], rarity: '史诗', isSpecial: true, desc: '每张放逐牌造成 14 伤害，并获得 3 护盾与 3 庇护；回洗 3 张以上时获得 1 层[闪避]。随后洗回牌库并触发回流伤害。' },
        ...
        { id: 'a_gale_verdict', name: '疾风裁决', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 18, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]。消耗至多 3 层风势：每层追加 10 伤害并获得 2 庇护，满 3 层获得 1 层闪避。' },
...
const RELIC_POOL = [
    ...
    { id: 'r_exile_cache', name: '流亡箭匣', icon: '📦', desc: '弓手：牌进入放逐区时额外造成 3 点流动伤害并获得 3 点庇护；带[放逐]的攻击牌额外造成 2 点伤害。', price: 200 },
