...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 'a_syn_magic', name: '回声导流', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['回响'], rarity: '史诗', isSpecial: true, desc: '使下一次伤害提高 12 并抽 2；回响时再提高 12 并抽 1。' },
        ...
        { id: 'm_status_supernova', name: '万象星爆', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 58, tags: ['爆发', '燃烧'], rarity: '史诗', isSpecial: true, desc: '造成 58 点伤害。敌方每种负面状态追加 18 伤害并获得 8 点庇护，随后施加最多 4 层[燃烧]。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_exec_claim', name: '罪痕重锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 1, icon: '⚖️', val: 12, tags: ['易伤', '重击'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 12 点[重击]伤害并施加[易伤]。' },
    ...
    hero_archer: [
        ...
        { id: 'a_venom_redfog', name: '赤雾落弦', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '攻击', cost: 1, icon: '🩸', val: 13, tags: ['出血', '追击'], directEffects: { draw: true }, buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '造成 13 点伤害，附带[追击]，施加[出血]并抽牌。' },
