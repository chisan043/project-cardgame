...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'a_syn_blood', name: '血海誓斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 42, tags: ['血债', '吸血'], lifestealRatio: 1, bloodDebtSpendAll: true, bloodDebtSpendDamage: 15, rarity: '史诗', isSpecial: true, desc: '造成 42 点穿甲伤害。耗尽血债：每点追加 15 伤害，并以全部伤害[吸血]；若敌人未倒下，按消耗血债提高本场伤害。' },
        ...
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 42, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 42 点[穿甲]。每层[易伤]追加 8 伤害，手牌每张[连击]/[穿甲]追加 10 伤害；若敌人未倒下，大幅提高本场伤害。' }
    ],
    hero_mage: [
        ...
        { id: 'm_status_supernova', name: '万象超新星', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 40, tags: ['爆发', '燃烧'], rarity: '史诗', isSpecial: true, desc: '造成 40 点伤害。敌方每种负面状态追加 12 伤害并获得 5 点庇护，随后施加最多 3 层[燃烧]。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 48, tags: ['爆发', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 48 点[穿甲]。每层[咏唱]追加 20 伤害并获得 5 庇护；若敌人未倒下，按消耗咏唱提高本场伤害。' },
