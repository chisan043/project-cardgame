...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 20, tags: ['爆发', '穿甲', '放逐'], rarity: '史诗', isSpecial: true, desc: '造成 20 点[穿甲]伤害并[放逐]。每有 1 层[咏唱]，额外造成 6 点伤害，然后消耗咏唱。' },
...
const BUILD_EXPANSION_RELICS = [
    ...
    { id: 'r_tailwind_spool', name: '顺风线轴', icon: '🧵', desc: '弓手：每回合首次通过卡牌获得风势或[错身]时，额外获得 1 层对应状态。', price: 160 },
