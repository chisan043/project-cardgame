...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'a_syn_blood', name: '血海誓斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 32, tags: ['吸血', '血祭', '放血'], rarity: '史诗', isSpecial: true, desc: '造成 32 点伤害，对首领追加其最大生命 20% 的伤害。每张血誓牌额外 +20，每层[出血]额外 +8；每张血誓牌失去 2 点生命，随后吸血。' },
        ...
        { id: 'w_oath_fortress', name: '誓约壁垒', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_scar_art_v1.webp', type: '防御', cost: 2, icon: '🏰', val: 9, tags: ['庇护', '保留'], rarity: '史诗', isSpecial: true, desc: '获得 9 点护盾与 3 点[庇护]。半血以下进入[反击]。' },
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 44, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 44 点[穿甲]伤害。对首领追加 15% 最大生命伤害；每层[易伤] +8，每张手牌中的[连击]或[穿甲]牌 +12，并获得庇护。' }
    ],
    hero_mage: [
        ...
        { id: 'a_syn_magic', name: '森罗雷仪', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 3, icon: '🌌', val: 0, tags: ['回响', '复刻', '充能'], rarity: '史诗', isSpecial: true, desc: '手牌中每有一张带[回响]或[复刻]的牌，降下一次天雷（造成 15 点[穿甲]伤害），并回复 1 点能量。' },
        ...
        { id: 'm_status_supernova', name: '万象超新星', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 36, tags: ['爆发', '燃烧'], rarity: '史诗', isSpecial: true, desc: '造成 36 点伤害。每种负面状态额外 +9 伤害与 4 点庇护，并施加最多 3 层[燃烧]。' },
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张牌，抽 1 张并获得 2 点庇护；对首领追加其最大生命 2% 的穿甲伤害。无目标时获得 2 层[咏唱]并抽 2 张。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 48, tags: ['爆发', '放逐', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 48 点[穿甲]伤害并[放逐]，对首领追加其最大生命 21% 的伤害。每层[咏唱]额外 +16 伤害与 4 点庇护，然后消耗咏唱。' },
        { id: 'm_curse_gravity', name: '咒星重力', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 2, icon: '⛓️', val: 0, tags: ['诅咒', '虚弱', '抽牌'], rarity: '史诗', isSpecial: true, desc: '施加 5 层[诅咒]与 3 层[虚弱]。敌方每有一种负面状态，你下一次伤害 +2；若已有 3 种以上负面状态，额外[抽牌] 1 张。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_blood_crucible', name: '血誓坩埚', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '🏺', val: 5, tags: ['血祭', '治愈'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '触发[血祭]后[治愈]。先把生命变成攻势，再立刻回稳。' },
        { id: 'w_blood_rain', name: '赤雨冲锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 7, tags: ['出血', '追击'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 7 点伤害，附带[追击]并施加[出血]。' },
        { id: 'w_blood_siphon', name: '噬誓回流', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 1, icon: '💍', val: 8, tags: ['吸血', '放血'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 8 点伤害，触发[放血]后[吸血]。' },
        { id: 'w_blood_drum', name: '战血鼓点', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 0, icon: '🥁', val: 5, tags: ['血祭', '充能'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '免费触发[血祭]并[充能]。用血量换一个更长的爆发回合。' },
        { id: 'w_blood_chain', name: '赤链二斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '攻击', cost: 1, icon: '⛓️', val: 6, tags: ['出血', '连击'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害，施加[出血]并触发[连击]。' },
        { id: 'w_blood_oathmark', name: '血印再立', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '📜', val: 5, tags: ['血祭', '抽牌'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '触发[血祭]并[抽牌]，把生命投入到继续找血誓组件。' },
        { id: 'w_blood_lastcup', name: '末杯回命', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🍷', val: 11, tags: ['吸血', '重击'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 11 点伤害，触发[吸血]与[重击]。' }
    ],
    hero_mage: [
        ...
        { id: 'm_mirror_twinseal', name: '双镜印', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_star_copy_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '同时触发[回响]与[复刻]。' },
        { id: 'm_mirror_rewind', name: '倒带法环', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🔁', val: 0, tags: ['复刻', '重置'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '触发[复刻]并[重置]手牌。' },
        { id: 'm_mirror_footnote', name: '镜页脚注', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_star_copy_art_v1.webp', type: '能力', cost: 0, icon: '📝', val: 0, tags: ['复刻', '销毁'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '触发[复刻]后[销毁]。' },
        { id: 'm_mirror_hallway', name: '折廊回声', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 2, icon: '🏛️', val: 0, tags: ['回响', '保留'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '触发[回响]并[保留]。' },
        { id: 'm_mirror_glassbolt', name: '镜棱短雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '💠', val: 6, tags: ['回响', '穿甲'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '造成 6 点[穿甲]伤害，附带[回响]。' },
        { id: 'm_calamity_plague_star', name: '疫星坠落', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_stasis_hex_art_v1.webp', type: '能力', cost: 2, icon: '☠️', val: 0, tags: ['剧毒', '诅咒'], buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '施加[剧毒]与[诅咒]。' },
        ...
        { id: 'm_calamity_silence', name: '血月禁言', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['眩晕', '出血'], buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '施加[眩晕]与[出血]。' },
...
const RELIC_POOL = [
    ...
    { id: 'r_vamp_ring', name: '血誓指环', icon: '💍', desc: '战士：带[吸血]的攻击溢出治疗时，本场战斗伤害提高，单次最多 +5。', price: 140 },
    ...
    { id: 'r_exhaust_dmg', name: '狩影烬坠', icon: '🔥', desc: '弓手：每当有卡牌被[放逐]，本场战斗所有伤害 +1。', price: 160 },
    ...
    { id: 'r_sword_oath', name: '圣剑誓印', icon: '⚔️', desc: '战士：[圣剑]攻击从护盾获得的伤害提升，由 50% 提高到 60%。', price: 190 },
...
const BUILD_EXPANSION_RELICS = [
    ...
    { id: 'r_bloodoath_contract', name: '血誓招令', icon: '🩸', desc: '核心遗物：锁定[血誓狂战]路线，将全部初始护盾牌改造为施加[出血]的血誓开锋，彻底放弃护盾并转向吸血与放血。', price: 180, isCore: true },
