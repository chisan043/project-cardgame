...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 's_pierce', name: '聚星紫雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '⚡', val: 38, tags: ['爆发'], rarity: '史诗', isSpecial: true, desc: '造成 38 点[穿甲]伤害。消耗全部[咏唱]，每层追加 18 伤害；无咏唱时改为积累 3 层[咏唱]。' },
        ...
        { id: 'm_curse_gravity', name: '咒星沉坠', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 1, icon: '⛓️', val: 0, tags: ['诅咒', '虚弱', '抽牌'], rarity: '史诗', isSpecial: true, desc: '施加 6[诅咒]与 4[虚弱]。敌方每种负面状态使下次伤害提高 4，抽 1；3 种以上回复 1 点能量。' },
    ...
    hero_archer: [
        ...
        { id: 'a_gale_verdict', name: '风冠断矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 1, icon: '💨', val: 18, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]；消耗至多 4 层风势，每层追加 12 伤害并获得 3 庇护。消耗 2 层以上抽 1。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_exec_line', name: '银线破甲', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 2, icon: '🗡️', val: 30, tags: ['穿甲', '连击', '易伤'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 30 点[穿甲]伤害并施加[易伤]；若本回合已出牌，伤害提高 50%。' },
        { id: 'w_exec_flash', name: '白刃一闪', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 0, icon: '⚡', val: 22, tags: ['穿甲', '易伤', '销毁'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 22 点[穿甲]伤害并施加[易伤]，然后[销毁]。' },
        ...
        { id: 'w_exec_rehearse', name: '刑步试探', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '能力', cost: 0, icon: '👣', val: 0, tags: ['重置', '充能'], directEffects: { draw: true }, drawCount: 1, buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '[重置]手牌，回复 1 点能量并抽 1 张牌。' },
...
const RELIC_POOL = [
    ...
    { id: 'r_sword_oath', name: '圣剑誓印', icon: '⚔️', desc: '战士：[圣剑]从护盾获得的追加伤害由 40% 提高到 55%，卡面会显示当前追加伤害。', price: 190 },
