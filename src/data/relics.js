...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 48, tags: ['爆发', '销毁', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 48 点[穿甲]后[销毁]。首领+21%最大生命；每层[咏唱]+16伤害/+4庇护。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_blood_rain', name: '赤雨冲锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 12, tags: ['血债'], bloodDebtGain: 3, bloodDebtBleed: 4, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '获得 3 点[血债]。造成 12 点伤害并施加 4 层出血。' },
