...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张牌，抽 1，+2 庇护；对首领追加 2% 最大生命。无目标时 +2[咏唱]并抽 2。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 48, tags: ['爆发', '放逐', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 48 点[穿甲]并[放逐]。首领+21%最大生命；每层[咏唱]+16伤害/+4庇护。' },
        { id: 'm_curse_gravity', name: '咒星重力', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 2, icon: '⛓️', val: 0, tags: ['诅咒', '虚弱', '抽牌'], rarity: '史诗', isSpecial: true, desc: '施加 5[诅咒]与 3[虚弱]。敌方每种负面使下次伤害 +2；3 种以上再抽 1。' },
        { id: 'm_blood_moon_rite', name: '血月仪轨', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', type: '能力', cost: 1, icon: '🩸', val: 0, tags: ['出血', '放血', '易伤'], rarity: '史诗', isSpecial: true, desc: '施加 6[出血]与 2[易伤]，立刻[放血]。若引爆出血，抽 1。' }
    ],
    hero_archer: [
        { id: 's_exhaust', name: '风葬归矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '能力', cost: 3, icon: '🕳️', val: 0, tags: ['放逐', '回收'], rarity: '史诗', isSpecial: true, desc: '每张放逐牌造成 15 伤害，+2 护盾/庇护；首领+10%最大生命。随后洗回放逐区。' },
        { id: 's_poison', name: '猎毒齐爆', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 2, icon: '💥', val: 36, tags: ['剧毒', '出血'], rarity: '史诗', isSpecial: true, desc: '造成 36 真实伤害；再造成[剧毒]+[出血]总层数 x3 伤害，不清层。按总层数获得至多 12 庇护。' },
        ...
        { id: 'a_wind_dance', name: '踏风连步', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '🪶', val: 0, tags: ['蓄力', '自然', '闪避'], rarity: '史诗', isSpecial: true, desc: '+4 风势与 1[闪避]，+1 能量并抽 1。若已有风势，+6[庇护]。' },
        { id: 'a_gale_verdict', name: '疾风裁决', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 18, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]，首领+2%最大生命。耗至多 3 风势：每层+10伤害/+2庇护，满3层+1闪避。' },
