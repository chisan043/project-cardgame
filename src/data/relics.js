...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'w_oath_fortress', name: '誓约壁垒', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_scar_art_v1.webp', type: '防御', cost: 2, icon: '🏰', val: 10, tags: ['庇护', '保留'], rarity: '史诗', isSpecial: true, desc: '获得 10 点护盾与 4 点[庇护]。半血以下进入[反击]。' },
    ...
    hero_mage: [
        ...
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张牌，抽 1 张并获得 2 点庇护；对首领追加其最大生命 4% 的穿甲伤害。无目标时获得 2 层[咏唱]并抽 2 张。' },
