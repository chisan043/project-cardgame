...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        { id: 's_shield', name: '誓盾开锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_release_art_v1.webp', type: '攻击', cost: 1, icon: '🛡️', val: 12, tags: ['圣剑'], rarity: '史诗', isSpecial: true, desc: '造成 12 点伤害，追加当前护盾 100% 的伤害，并结算[圣剑]；进入[反击]姿态。' },
        { id: 's_thorns', name: '蔷薇誓壁', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_guard_art_v1.webp', type: '防御', cost: 2, icon: '🛡️', val: 18, tags: ['荆棘'], rarity: '史诗', isSpecial: true, desc: '获得 18 点护盾与 8 层[荆棘]。' },
        { id: 'a_syn_sword', name: '裂隙裁决', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 2, icon: '🗡️', val: 28, tags: ['穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 28 点[穿甲]伤害。若敌方已有[易伤]且未倒下，本场战斗所有伤害 +12。' },
        { id: 'a_syn_array', name: '圣誓护阵', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_scar_art_v1.webp', type: '防御', cost: 2, icon: '⛩️', val: 16, tags: ['反击'], rarity: '史诗', isSpecial: true, desc: '获得 16 点护盾并进入[反击]；若已处于反击，改为获得 8 点[庇护]。' },
        { id: 'a_syn_blood', name: '血誓饮锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 12, tags: ['血誓', '吸血'], lifestealRatio: 0.4, bloodOathMissingRatio: 0.72, magicSwordGrowth: 1, rarity: '史诗', isSpecial: true, desc: '造成 12 点穿甲伤害；追加已损生命 72% 的伤害；按 40% 伤害[吸血]；魔剑永久 +1 伤害。' },
        { id: 'w_counter_crown', name: '王冠返锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_crown_riposte_art_v1.webp', type: '攻击', cost: 3, icon: '👑', val: 16, tags: ['反击', '圣剑'], rarity: '史诗', isSpecial: true, desc: '造成 16 点伤害并结算圣剑追加伤害；进入[反击]姿态。本场战斗中，每次反击后获得等同本次招架值的护盾。' },
        { id: 'w_bastion_prayer', name: '圣壁祷文', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_banner_guard_art_v1.webp', type: '能力', cost: 1, icon: '🚩', val: 10, tags: ['庇护', '抽牌'], rarity: '史诗', isSpecial: true, desc: '获得 10 点[庇护]，若当前拥有护盾，再获得等同庇护值的护盾并[抽牌]。' },
        { id: 'w_thorn_judgement', name: '荆冠裁决', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_thorn_charge_art_v1.webp', type: '攻击', cost: 1, icon: '🌹', val: 10, tags: ['圣剑', '荆棘'], rarity: '史诗', isSpecial: true, desc: '造成 10 点伤害并结算圣剑追加伤害；再按当前[荆棘]层数追加 4 倍伤害，并获得 8 层[荆棘]。' },
        { id: 'w_oath_fortress', name: '誓垒不落', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_scar_art_v1.webp', type: '防御', cost: 3, icon: '🏰', val: 18, tags: ['反击', '保留'], rarity: '史诗', isSpecial: true, desc: '获得 18 点护盾与 6 点庇护并进入[反击]。打出后下回合回到手牌。' },
        { id: 'w_last_verdict', name: '终誓裁决', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 64, tags: ['穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 64 点[穿甲]伤害；每层[易伤]追加 10 伤害；手牌每张[连击]/[穿甲]牌追加 10 伤害。' }
    ],
    hero_mage: [
        { id: 's_magic', name: '镜界复写', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_cascade_art_v1.webp', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['复刻'], energyOnCopy: 1, rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌两次，回复 1 点能量并抽 1；无目标时抽 3 张牌。' },
        { id: 's_pierce', name: '聚星紫雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '⚡', val: 44, tags: ['爆发'], rarity: '史诗', isSpecial: true, desc: '造成 44 点[穿甲]伤害。消耗全部[咏唱]，每层追加 20 伤害；无咏唱时改为积累 4 层[咏唱]。' },
        { id: 'a_syn_magic', name: '回声导流', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['回响'], nextDamageBonus: 16, drawCount: 2, echoDrawCount: 1, rarity: '史诗', isSpecial: true, desc: '使下一次伤害提高 16 并抽 2；回响时再提高 16 并抽 1。' },
        { id: 'm_chant_singularity', name: '星核启咏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_chant_art_v1.webp', type: '能力', cost: 1, icon: '🔮', val: 0, tags: ['咏唱', '充能'], rarity: '史诗', isSpecial: true, desc: '获得 3 层[咏唱]并回复 1 点能量。若敌方有负面状态，额外[抽牌] 1 张。' },
        { id: 'm_status_supernova', name: '万象星爆', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 60, tags: ['燃烧'], buildTags: ['calamity'], debuffDamageBonus: 20, burnCap: 5, rarity: '史诗', isSpecial: true, desc: '造成 60 点伤害。敌方每种负面状态追加 20 伤害并获得 8 点庇护，随后施加最多 5 层[燃烧]。' },
        { id: 'm_echo_archive', name: '回声秘卷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌，抽 1，并使下一次伤害 +14。无目标时积累 3 层[咏唱]并抽 2。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁咒', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 56, tags: ['爆发', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 56 点[穿甲]。每层[咏唱]追加 24 伤害并获得 6 庇护；消耗咏唱且敌人未倒下时，本场战斗所有伤害 +10 至 +36。' },
        { id: 'm_curse_gravity', name: '咒星沉坠', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 1, icon: '⛓️', val: 0, tags: ['诅咒', '虚弱', '抽牌'], rarity: '史诗', isSpecial: true, desc: '施加 6[诅咒]与 4[虚弱]。敌方每种负面状态使下次伤害提高 6，抽 1；3 种以上回复 1 点能量。' },
        { id: 'm_blood_moon_rite', name: '暗月祭仪', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', type: '能力', cost: 1, icon: '🌙', val: 0, tags: ['诅咒', '易伤'], rarity: '史诗', isSpecial: true, desc: '施加 5[诅咒]与 2[易伤]。敌方每种负面状态造成 6 点灾厄伤害。' }
    ],
    hero_archer: [
        { id: 's_exhaust', name: '风葬归矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '能力', cost: 3, icon: '🕳️', val: 0, tags: ['放逐', '回收'], rarity: '史诗', isSpecial: true, desc: '每张放逐牌造成 14 点[流动伤害]，随后洗回牌库；每回收 2 张获得 1 层风势与 1 层[闪避]。' },
        ...
        { id: 'a_syn_poison', name: '万毒森阵', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_hawkeye_art_v1.webp', type: '能力', cost: 1, icon: '🧪', val: 0, tags: ['剧毒', '出血'], basePoison: 6, baseBleed: 6, baseDamage: 10, poisonPerDiscard: 6, bleedPerDiscard: 6, damagePerDiscard: 10, protectVal: 8, drawCount: 1, energyOnDiscard: 1, rarity: '史诗', isSpecial: true, desc: '施加 6 层剧毒与出血并造成 10 伤害；丢弃手牌所有[剧毒]/[出血]牌，每弃 1 张追加 6 层剧毒与出血、10 伤害。抽 1；若弃过牌，回复 1 点能量；获得 8 点庇护。' },
        { id: 's_energy', name: '风王束羽', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 0, icon: '🍃', val: 0, tags: ['蓄力'], rarity: '史诗', isSpecial: true, desc: '获得 3 层风势并抽 1 张牌；若已有风势，回复 1 点能量。' },
        { id: 'a_wind_dance', name: '踏风连步', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '🪶', val: 0, tags: ['蓄力', '自然', '闪避'], rarity: '史诗', isSpecial: true, desc: '获得 3 层风势与 1 层[闪避]，回复 1 点能量并抽 1。若已有风势，获得 4 点[庇护]。' },
        { id: 'a_gale_verdict', name: '风冠断矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 1, icon: '💨', val: 18, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]；消耗至多 4 层风势，每层追加 10 伤害并获得 2 庇护。消耗 2 层以上抽 1。' },
        ...
        { id: 'a_bloodlet_gale', name: '断脉赤矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '攻击', cost: 1, icon: '🩸', val: 12, tags: ['放血', '剧毒', '抽牌'], rarity: '史诗', isSpecial: true, desc: '造成 12 点伤害，施加 4 层[剧毒]并触发[放血]。抽 1，获得庇护；引爆出血时不清空出血。' },
        { id: 'a_green_resonance', name: '翠林回响', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 1, icon: '🍃', val: 0, tags: ['自然', '回收'], rarity: '史诗', isSpecial: true, desc: '抽 1，触发[自然]并获得 3 层风势。' },
        { id: 'a_skyfall_shot', name: '坠星绝矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 2, icon: '🌠', val: 26, tags: ['放逐', '穿甲', '追击'], exileDamagePerCard: 3, exileDamageCap: 24, rarity: '史诗', isSpecial: true, desc: '造成 26 点[穿甲]伤害并[放逐]，进入放逐区时造成 5 点[流动伤害]。放逐区每有 1 张牌，此牌额外造成 3 点伤害，最多 24 点。' }
    ]
};

const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        { id: 'w_oath_clock', name: '誓钟返击', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_crown_riposte_art_v1.webp', type: '防御', cost: 1, icon: '🕰️', val: 12, tags: ['反击', '保留'], directEffects: { protection: true }, protectVal: 8, buildTags: ['oathblade'], rarity: '史诗', isSpecial: true, desc: '获得护盾与 8 点[庇护]，进入[反击]姿态。打出后下回合回到手牌。' },
        { id: 'w_exec_silence', name: '断声刑令', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '能力', cost: 0, icon: '⛓️', val: 0, tags: ['眩晕', '易伤'], directEffects: { draw: true }, buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '施加[眩晕]与[易伤]并抽 1 张牌。' },
        { id: 'w_exec_line', name: '银线破甲', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 1, icon: '🗡️', val: 34, tags: ['穿甲', '连击', '易伤'], drawOnCombo: 1, buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '先施加[易伤]，再造成 34 点[穿甲]伤害；若本回合已出牌，伤害提高 50%并抽 1 张牌。' },
        { id: 'w_exec_flash', name: '白刃一闪', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 0, icon: '⚡', val: 20, tags: ['穿甲', '易伤', '连击'], directEffects: { draw: true, protection: true }, protectVal: 6, buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 20 点[穿甲]伤害并施加[易伤]；若本回合已出过牌，伤害提高 50%。抽 1 并获得 6 点[庇护]。' },
        { id: 'w_exec_claim', name: '罪痕重锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 1, icon: '⚖️', val: 15, tags: ['易伤', '重击'], directEffects: { draw: true }, buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 15 点[重击]伤害并施加[易伤]，抽 1 张牌。' },
        { id: 'w_exec_rehearse', name: '刑步试探', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '能力', cost: 0, icon: '👣', val: 0, tags: ['充能', '抽牌'], directEffects: { draw: true, energy: true, protection: true }, drawCount: 2, protectVal: 6, buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '回复 1 点能量，抽 2 张牌并获得 6 点[庇护]。' },
        ...
        { id: 'w_blood_crucible', name: '血誓熔炉', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '🏺', val: 0, tags: ['血誓', '抽牌'], bloodOathCost: 4, drawCount: 3, bloodDebtWeak: 2, directEffects: { draw: true, energy: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 4 点生命，抽 3 张牌，回复 1 点能量并施加 2 层[虚弱]。' },
        { id: 'w_blood_rain', name: '赤雨突进', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 24, tags: ['血誓'], bloodOathCost: 4, bloodOathMissingRatio: 0.9, bloodDebtBleed: 12, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 4 点生命；造成伤害；血誓追加伤害并施加 12 层出血，抽 1 张牌。' },
        { id: 'w_blood_siphon', name: '噬血回锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 1, icon: '💍', val: 11, tags: ['吸血', '放血'], lifestealRatio: 0.75, bloodOathMissingRatio: 0.4, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成伤害并触发[放血]；血誓追加伤害，施加 1 层[虚弱]，并按 75% 伤害[吸血]。' },
        { id: 'w_blood_drum', name: '血鼓战誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 0, icon: '🥁', val: 0, tags: ['血誓'], bloodOathCost: 4, directEffects: { energy: true, draw: true }, drawCount: 2, turnDamageBonus: 4, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 4 点生命，回复 1 点能量并抽 2 张牌；本回合攻击伤害 +4。' },
        { id: 'w_blood_chain', name: '赤链双斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '攻击', cost: 1, icon: '⛓️', val: 14, tags: ['血誓', '连击'], bloodOathMissingRatio: 0.75, bloodDebtWeak: 2, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成伤害；血誓追加伤害；若本回合已出牌，伤害提高 50%，并施加 2 层[虚弱]。' },
        { id: 'w_blood_oathmark', name: '血印再誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '📜', val: 0, tags: ['血誓', '抽牌'], bloodOathCost: 4, drawCount: 2, directEffects: { draw: true, energy: true, protection: true }, protectVal: 12, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 4 点生命，抽 2 张牌，回复 1 点能量并获得 12 点[庇护]。' },
        { id: 'w_blood_lastcup', name: '末杯回命', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🍷', val: 18, tags: ['吸血', '重击'], lifestealRatio: 0.6, bloodOathMissingRatio: 0.28, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成[重击]伤害；血誓追加伤害，并按 60% 伤害[吸血]。' }
    ],
    hero_mage: [
        { id: 'm_chant_overflow', name: '溢星续咏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_chant_art_v1.webp', type: '能力', cost: 1, icon: '🔮', val: 0, tags: ['咏唱', '充能'], directEffects: { draw: true }, buildTags: ['chant'], rarity: '史诗', isSpecial: true, desc: '积累[咏唱]，回复 1 点能量并抽 1 张牌。' },
        { id: 'm_chant_bolt', name: '星涌紫雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '⚡', val: 18, tags: ['爆发', '充能'], directEffects: { draw: true }, buildTags: ['chant'], rarity: '史诗', isSpecial: true, desc: '造成 18 点伤害，附带[爆发]，回复 1 点能量并抽 1。' },
        ...
        { id: 'm_chant_lockstar', name: '锁星刻读', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '能力', cost: 1, icon: '🎯', val: 0, tags: ['咏唱', '易伤'], directEffects: { energy: true }, buildTags: ['chant'], rarity: '史诗', isSpecial: true, desc: '积累[咏唱]，施加[易伤]并回复 1 点能量。' },
        { id: 'm_mirror_twinseal', name: '双镜秘印', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_star_copy_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['复刻', '充能'], directEffects: { draw: true }, buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌，回复 1 点能量并抽 1 张牌。' },
        { id: 'm_mirror_rewind', name: '逆时法环', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🔁', val: 0, tags: ['复刻', '重置'], directEffects: { energy: true }, buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌，[重置]手牌并回复 1 点能量。' },
        { id: 'm_mirror_footnote', name: '镜页批注', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_star_copy_art_v1.webp', type: '能力', cost: 0, icon: '📝', val: 0, tags: ['复刻', '销毁'], directEffects: { draw: true }, drawCount: 2, buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌并抽 2 张牌，打出后[销毁]。' },
        { id: 'm_mirror_hallway', name: '镜廊回声', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🏛️', val: 0, tags: ['回响', '保留'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌，并使下一次伤害提高 16；回响时再次提高 16 并回复 1 点能量。打出后下回合回到手牌。' },
        { id: 'm_mirror_glassbolt', name: '镜棱紫雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '💠', val: 18, tags: ['回响', '穿甲'], directEffects: { draw: true }, buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]伤害，抽 1，并让本牌再触发一次。' },
        { id: 'm_calamity_plague_star', name: '疫星坠落', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_stasis_hex_art_v1.webp', type: '能力', cost: 1, icon: '☠️', val: 0, tags: ['诅咒', '虚弱'], extraVulnerable: 1, directEffects: { draw: true, energy: true }, buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '施加[诅咒]、[虚弱]与 1 层[易伤]，抽 1 并回复 1 点能量。' },
        { id: 'm_calamity_black_snow', name: '黑雪预兆', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', type: '攻击', cost: 1, icon: '🌑', val: 18, tags: ['虚弱', '燃烧', '诅咒'], directEffects: { draw: true }, debuffDamageBonus: 6, debuffDamageCap: 5, buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '造成 18 点伤害，施加[虚弱]、[燃烧]与[诅咒]并抽 1 张牌；敌方每种负面状态追加 6 点灾厄伤害，最多 5 种。' },
        ...
        { id: 'm_calamity_blacklist', name: '厄名录', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_stasis_hex_art_v1.webp', type: '能力', cost: 1, icon: '📓', val: 0, tags: ['诅咒', '易伤'], directEffects: { draw: true }, buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '施加[诅咒]与[易伤]并抽 1 张牌。' }
    ],
    hero_archer: [
        ...
        { id: 'a_gale_splinter', name: '碎风齐射', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 1, icon: '💨', val: 15, tags: ['追击'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 15 点伤害并触发[追击]。' },
        { id: 'a_gale_crosswind', name: '侧风留痕', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '📏', val: 1, tags: ['自然', '闪避', '易伤'], directEffects: { draw: true, protection: true }, protectVal: 6, sidestepVal: 2, buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '触发[自然]，获得 2 层[闪避]，施加[易伤]，获得 6 点[庇护]并抽 1。' },
        { id: 'a_gale_featherbank', name: '百羽齐发', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '🏹', val: 15, tags: ['追击', '抽牌'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成伤害，触发[追击]并抽牌。' },
        ...
        { id: 'a_venom_burst', name: '毒脉裂放', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_blood_release_art_v1.webp', type: '攻击', cost: 1, icon: '☠️', val: 16, tags: ['放血', '剧毒'], directEffects: { draw: true, protection: true }, protectVal: 8, buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '造成伤害，施加[剧毒]并触发[放血]；抽 1，获得 8 点[庇护]，且有剧毒时不清空出血。' },
        { id: 'a_venom_cage', name: '腐藤缚网', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 1, icon: '🕸️', val: 0, tags: ['剧毒', '眩晕'], directEffects: { draw: true }, buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '施加[剧毒]与[眩晕]并抽 1 张牌。' },
        { id: 'a_venom_redfog', name: '赤雾落弦', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '攻击', cost: 1, icon: '🩸', val: 15, tags: ['出血', '追击'], directEffects: { draw: true, protection: true }, protectVal: 4, buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '造成 15 点伤害，附带[追击]，施加[出血]，抽牌并获得 4 点庇护。' },
        ...
        { id: 'a_exile_recall', name: '归巢双令', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 1, icon: '🧭', val: 8, tags: ['回收', '蓄力'], directEffects: { energy: true }, drawOnExhaustPile: 1, buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '获得 2 层风势并回复 1 点能量；若放逐区有牌，抽 1。' },
        ...
        { id: 'a_exile_piercer', name: '林外穿枝', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 2, icon: '🌠', val: 22, tags: ['放逐', '穿甲'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '造成[穿甲]伤害并[放逐]；进入放逐区时造成[流动伤害]。' },
        { id: 'a_exile_archive', name: '失林归卷', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_cycle_branch_art_v1.webp', type: '能力', cost: 1, icon: '📚', val: 0, tags: ['回收'], directEffects: { draw: true, energy: true }, buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌并回复 1 点能量。' }
    ]
};
...
const RELIC_POOL = [
    ...
    { id: 'r_start_mage', name: '余辉法印', icon: '🔯', desc: '法师初始遗物：每回合第一次打出能力牌后，下一张攻击牌结算前获得 2 层[咏唱]。', price: 0 },
    { id: 'r_start_archer', name: '逐风羽饰', icon: '🪶', desc: '弓手初始遗物：每回合第一次打出能力牌后，下一张攻击牌结算时获得 1 层风势与 3 点[庇护]；战斗胜利后回复 16 点生命。', price: 0 },
    { id: 'r_bone_ring', name: '誓约骨环', icon: '🦴', desc: '战士/弓手：每丢弃 1 张非诅咒手牌，本场战斗所有伤害提高 1；适合把弃牌转成血誓卖血、处刑连段或重置爆发。', price: 100 },
    { id: 'r_frenzy_veil', name: '疾影面纱', icon: '🎭', desc: '弓手：触发[重置]时额外[抽牌] 1 张；每弃 2 张牌，[狂热]本回合伤害额外 +1。', price: 130 },
    { id: 'r_sac_jade', name: '咏唱玉坠', icon: '📿', desc: '法师：每次获得[咏唱]时，回复 1 点能量并获得 2 点庇护。', price: 150 },
    { id: 'r_enchant_crys', name: '紫焰棱晶', icon: '💎', desc: '法师：触发[附魔]时加成翻倍；[爆发]额外追加至少 3 点伤害，消耗咏唱时每层再 +2。', price: 140 },
    { id: 'r_poison_fang', name: '森蚀箭簇', icon: '🐍', desc: '弓手：施加[剧毒]或[出血]时额外增加 1 层。', price: 120 },
    { id: 'r_bleed_knife', name: '猎痕短刃', icon: '🔪', desc: '弓手：引爆[放血]时，每层额外造成 2 点伤害，并补 1 层[剧毒]。', price: 160 },
    { id: 'r_weak_mask', name: '破势面具', icon: '🎭', desc: '法师/弓手：施加[易伤]或[虚弱]时持续回合延长 1。', price: 130 },
    { id: 'r_thorn_shield_new', name: '蔷薇重盾', icon: '🛡️', desc: '战士：[荆棘]效果提高；战斗开始时获得 6 点护盾。', price: 180 },
    ...
    { id: 'r_sword_oath', name: '圣剑誓印', icon: '⚔️', desc: '战士：[圣剑]从护盾获得的追加伤害由 40% 提高到 70%，反击追加由 +4 提高到 +8。', price: 190 },
    ...
    { id: 'r_burst_lens', name: '聚爆透镜', icon: '🔍', desc: '法师：[爆发]或裂星禁咒消耗咏唱后会保留一半咏唱层数。', price: 230 },
    ...
    { id: 'r_bloodlet_draw', name: '赤脉弦扣', icon: '🩸', desc: '弓手：触发[放血]并成功引爆出血后，额外[抽牌] 1 张并造成 4 点流动伤害。', price: 170 },
...
const BUILD_EXPANSION_RELICS = [
    ...
    { id: 'r_execute_scabbard', name: '断罪剑鞘', icon: '🗡️', desc: '战士：[重击]命中带[易伤]的敌人时，额外造成 24 点[穿甲]伤害；若敌人未倒下，本场战斗所有伤害 +6。', price: 190 },
    ...
    { id: 'r_status_ledger', name: '异状账簿', icon: '📒', desc: '法师：敌方负面状态达到 2 种时，每回合首次能力牌额外[抽牌] 1 张。', price: 170 },
    ...
    { id: 'r_gray_market_map', name: '灰市地图', icon: '🗺️', desc: '通用：卡牌奖励与商栈补货中，带职业构筑方向的卡牌权重提高 25%。', price: 180 },
