...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'a_syn_blood', name: '血海终誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 16, tags: ['血债', '吸血'], lifestealRatio: 1, bloodDebtSpendAll: true, bloodDebtSpendDamage: 2, rarity: '史诗', isSpecial: true, desc: '造成 16 点穿甲伤害。耗尽血债：每点追加 2 伤害，并以全部伤害[吸血]；用于清偿血债并完成收束。' },
        ...
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 48, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 48 点[穿甲]。每层[易伤]追加 6 伤害，手牌每张[连击]/[穿甲]追加 6 伤害；用于补足处刑窗口的收束。' }
    ],
    hero_mage: [
    ...
    hero_archer: [
        ...
        { id: 'a_gale_verdict', name: '风冠裁矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 14, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 14 点[穿甲]。消耗至多 3 层风势：每层追加 6 伤害并获得 1 庇护；用于收束疾风窗口。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_exec_line', name: '银线断甲', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 2, icon: '🗡️', val: 13, tags: ['穿甲', '连击'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 13 点伤害。若本回合已出牌，[连击]会放大这次[穿甲]攻击。' },
