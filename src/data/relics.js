...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_archer: [
        { id: 's_exhaust', name: '风葬归矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '能力', cost: 3, icon: '🕳️', val: 0, tags: ['放逐', '回收'], rarity: '史诗', isSpecial: true, desc: '每张放逐牌造成 15 点伤害，并获得 2 点护盾与庇护；对首领追加其最大生命 10% 的伤害。随后洗回放逐区。' },
        ...
        { id: 'a_gale_verdict', name: '疾风裁决', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 18, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]伤害，对首领追加其最大生命 2% 的伤害。最多消耗 3 层风势，每层额外 +10 伤害与 2 点庇护；若消耗 3 层，获得 1 层闪避。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_blood_crucible', name: '血誓坩埚', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '🏺', val: 0, tags: ['血债'], bloodDebtGain: 6, bloodDebtPowerGain: 0.75, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '获得 6 点[血债]。本回合血债伤害倍率 +75%。' },
        { id: 'w_blood_rain', name: '赤雨冲锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 8, tags: ['血债', '追击'], bloodDebtGain: 3, bloodDebtBleed: 4, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '获得 3 点[血债]。造成 8 点伤害并触发[追击]，每次施加 4 层出血。' },
        { id: 'w_blood_siphon', name: '噬誓回流', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 1, icon: '💍', val: 8, tags: ['吸血', '放血'], bloodDebtRepayFromBleed: 1, bloodDebtClearDamage: 8, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 8 点伤害并触发[放血]，按全部放血伤害偿债，随后[吸血]。完全清偿时追加 8 点伤害。' },
        ...
        { id: 'w_blood_chain', name: '赤链二斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '攻击', cost: 1, icon: '⛓️', val: 6, tags: ['血债', '连击'], bloodDebtDamageRatio: 0.75, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害并追加当前血债 75% 的伤害；若本回合已出牌，再触发[连击]。' },
        ...
        { id: 'w_blood_lastcup', name: '末杯回命', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🍷', val: 12, tags: ['吸血', '重击'], bloodDebtClearHeal: 8, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 12 点[重击]伤害并[吸血]。若完全清偿血债，额外回复 8 点生命。' }
    ],
    hero_mage: [
...
const RELIC_POOL = [
    ...
    { id: 'r_vamp_ring', name: '血誓指环', icon: '💍', desc: '战士：[吸血]偿清血债并产生溢出治疗时，本场战斗伤害提高，单次最多 +5。', price: 140 },
