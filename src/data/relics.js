...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'w_last_verdict', name: '终誓裁决', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 64, tags: ['穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 64 点[穿甲]伤害；每层[易伤]追加 10 伤害；手牌每张[连击]/[穿甲]牌追加 6 伤害。' }
    ],
    hero_mage: [
