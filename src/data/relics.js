...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        ...
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌，抽 1，并获得 2 庇护；对首领追加 2% 最大生命。无目标时 +2[咏唱]并抽 2。' },
