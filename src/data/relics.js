...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    ...
    hero_archer: [
        ...
        { id: 'a_exile_archive', name: '失林归卷', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_cycle_branch_art_v1.webp', type: '能力', cost: 1, icon: '📚', val: 0, tags: ['回收'], directEffects: { draw: true, energy: true }, buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '回收墓地牌与放逐区牌，抽 1 张牌并回复 1 点能量；回收放逐牌时造成[流动伤害]。' }
    ]
};
