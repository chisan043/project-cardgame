...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'a_syn_blood', name: '血海誓斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 6, tags: ['吸血', '血祭', '放血'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害。你手牌中每有一张带[血祭]、[吸血]、[出血]或[放血]的牌，失去 2 点生命并额外造成 15 点伤害，随后吸血。' },
        ...
        { id: 'w_oath_fortress', name: '誓约壁垒', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_scar_art_v1.webp', type: '防御', cost: 2, icon: '🏰', val: 18, tags: ['庇护', '保留'], rarity: '史诗', isSpecial: true, desc: '获得 18 点护盾与 8 点[庇护]。若生命低于一半，额外进入[反击]姿态。' },
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 18, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲]伤害。敌方每有 1 层[易伤]，额外造成 4 点伤害；你手牌中每有一张[连击]或[穿甲]牌，再额外造成 6 点伤害。' }
    ],
    hero_mage: [
        ...
        { id: 'm_status_supernova', name: '万象超新星', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 8, tags: ['爆发', '燃烧'], rarity: '史诗', isSpecial: true, desc: '造成 8 点伤害。敌方每有一种负面状态，额外造成 8 点伤害并施加 1 层[燃烧]。' },
        { id: 'm_echo_archive', name: '回声秘藏', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🪞', val: 0, tags: ['回响', '复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张打出的牌的效果；若没有可复制目标，则获得 2 层[咏唱]并[抽牌]。' },
        ...
        { id: 'm_forbidden_comet', name: '裂星禁术', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '🌌', val: 20, tags: ['爆发', '穿甲', '放逐'], rarity: '史诗', isSpecial: true, desc: '造成 20 点[穿甲]伤害并[放逐]。每有 1 层[咏唱]，额外造成 6 点伤害，然后消耗所有咏唱。' },
    ...
    hero_archer: [
        { id: 's_exhaust', name: '风葬归矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '能力', cost: 3, icon: '🕳️', val: 0, tags: ['放逐', '轮回'], rarity: '史诗', isSpecial: true, desc: '造成伤害，数值为[放逐]区卡牌数 × 15。随后将[放逐]区所有卡牌洗入抽牌堆。' },
        { id: 's_poison', name: '猎毒齐爆', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 2, icon: '💥', val: 0, tags: ['剧毒', '出血'], rarity: '史诗', isSpecial: true, desc: '引爆敌方所有的[剧毒]和[出血]层数，直接造成其层数总和 2 倍的真实伤害，且不清除层数。' },
        ...
        { id: 'a_wind_dance', name: '踏风连步', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '🪶', val: 0, tags: ['蓄力', '自然'], rarity: '史诗', isSpecial: true, desc: '获得 4 层风势，回复 1 点能量并[抽牌] 1 张。若已有风势，额外获得 6 点[庇护]。' },
        { id: 'a_gale_verdict', name: '疾风裁决', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 8, tags: ['连射', '穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 8 点[穿甲]伤害。每有 1 层风势，额外追加一次 4 点追射，并消耗最多 3 层风势。' },
        { id: 'a_red_rain', name: '赤痕箭雨', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 7, tags: ['出血', '多段'], rarity: '史诗', isSpecial: true, desc: '造成 7 点伤害并施加 8 层[出血]。若敌方已有[剧毒]，额外施加 4 层[剧毒]并[抽牌] 1 张。' },
        ...
        { id: 'a_green_resonance', name: '翠林回响', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 1, icon: '🍃', val: 0, tags: ['自然', '拾遗'], rarity: '史诗', isSpecial: true, desc: '从墓地选择 1 张牌回到手牌，随后触发[自然]并获得 2 层风势。' },
        { id: 'a_skyfall_shot', name: '坠星绝矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 2, icon: '🌠', val: 16, tags: ['放逐', '穿甲', '多段'], rarity: '史诗', isSpecial: true, desc: '造成 16 点[穿甲]伤害并[放逐]。放逐区每有 2 张牌，此牌额外造成 4 点伤害。' }
    ]
};
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_blood_rain', name: '赤雨冲锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 7, tags: ['出血', '多段'], buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 7 点伤害，附带[多段]并施加[出血]。' },
    ...
    hero_archer: [
        { id: 'a_gale_updraft', name: '上升气流', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '🪶', val: 0, tags: ['蓄力', '抽牌'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '获得风势并[抽牌]。' },
        { id: 'a_gale_splinter', name: '碎风齐射', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 1, icon: '💨', val: 5, tags: ['连射', '多段'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 5 点伤害，附带[连射]与[多段]。' },
        { id: 'a_gale_crosswind', name: '侧风判线', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '📏', val: 0, tags: ['自然', '易伤'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '触发[自然]并施加[易伤]。' },
        { id: 'a_gale_featherbank', name: '羽库连装', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '🏹', val: 6, tags: ['连射', '抽牌'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害，触发[连射]并[抽牌]。' },
        ...
        { id: 'a_venom_redfog', name: '赤雾落弦', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_rain_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 6, tags: ['出血', '多段'], buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害，附带[多段]并施加[出血]。' },
        ...
        { id: 'a_exile_recall', name: '归途双令', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 1, icon: '🧭', val: 0, tags: ['招魂', '轮回'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '触发[招魂]与[轮回]。' },
        { id: 'a_exile_knives', name: '影匣飞刀', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 0, icon: '🗡️', val: 4, tags: ['放逐', '销毁'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '造成 4 点伤害后[放逐]并[销毁]。' },
        ...
        { id: 'a_exile_archive', name: '失林归档', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_cycle_branch_art_v1.webp', type: '能力', cost: 2, icon: '📚', val: 0, tags: ['拾遗', '轮回'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '触发[拾遗]与[轮回]。' }
    ]
};
