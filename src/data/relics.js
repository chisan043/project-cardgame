...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'a_syn_sword', name: '破绽断裁', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 2, icon: '🗡️', val: 28, tags: ['穿甲'], rarity: '史诗', isSpecial: true, desc: '造成 28 点[穿甲]伤害。若敌方已有[易伤]，提高本场伤害。' },
        { id: 'a_syn_array', name: '守誓阵列', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_scar_art_v1.webp', type: '防御', cost: 2, icon: '⛩️', val: 16, tags: ['反击'], rarity: '史诗', isSpecial: true, desc: '获得 16 点护盾并进入[反击]；若已处于反击，改为获得 8 点[庇护]。' },
    ...
    hero_mage: [
        ...
        { id: 'a_syn_magic', name: '回声导线', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['回响'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌，并使下一次伤害提高 8。' },
    ...
    hero_archer: [
        ...
        { id: 's_poison', name: '猎毒齐爆', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 2, icon: '💥', val: 20, tags: ['剧毒', '出血'], rarity: '史诗', isSpecial: true, desc: '造成 20 真实伤害；再按剧毒与出血总层数造成 2 倍伤害，不清层。按总层数获得至多 8 庇护。' },
        ...
        { id: 'a_gale_verdict', name: '疾风裁决', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 14, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 14 点[穿甲]。消耗至多 3 层风势：每层追加 6 伤害并获得 1 庇护；用于收束疾风窗口。' },
