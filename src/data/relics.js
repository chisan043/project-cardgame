...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        { id: 's_shield', name: '誓盾出锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_release_art_v1.webp', type: '攻击', cost: 2, icon: '🛡️', val: 0, tags: ['圣剑'], rarity: '史诗', isSpecial: true, desc: '造成等同当前护盾值的伤害，并进入[反击]。' },
        ...
        { id: 'a_syn_blood', name: '血海终誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 16, tags: ['血誓', '吸血'], lifestealRatio: 0.75, bloodOathMissingRatio: 1.25, rarity: '史诗', isSpecial: true, desc: '造成 16 点穿甲伤害；追加已损生命 125% 的伤害；按 75% 伤害[吸血]。' },
        ...
        { id: 'w_last_verdict', name: '终誓处刑', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 2, icon: '⚔️', val: 48, tags: ['穿甲', '重击'], rarity: '史诗', isSpecial: true, desc: '造成 48 点[穿甲]；每层[易伤]追加 6 伤害；手牌每张[连击]/[穿甲]追加 6 伤害。' }
    ],
    hero_mage: [
        { id: 's_magic', name: '镜界回放', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_cascade_art_v1.webp', type: '能力', cost: 2, icon: '🌌', val: 0, tags: ['复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌两次；无目标时抽 2 张牌。' },
        { id: 's_pierce', name: '聚星雷矢', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 2, icon: '⚡', val: 32, tags: ['爆发'], rarity: '史诗', isSpecial: true, desc: '造成 32 点[穿甲]伤害。消耗全部[咏唱]，每层追加 14 伤害。' },
        { id: 'a_syn_magic', name: '回声秘线', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_void_art_v1.webp', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['回响'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌，并使下一次伤害提高 8。' },
        ...
        { id: 'm_status_supernova', name: '万象超新星', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_flame_art_v1.webp', type: '攻击', cost: 2, icon: '💥', val: 52, tags: ['爆发', '燃烧'], rarity: '史诗', isSpecial: true, desc: '造成 52 点伤害。敌方每种负面状态追加 16 伤害并获得 6 点庇护，随后施加最多 4 层[燃烧]。' },
    ...
    hero_archer: [
        ...
        { id: 's_poison', name: '青毒终绽', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 2, icon: '💥', val: 20, tags: ['剧毒', '出血'], rarity: '史诗', isSpecial: true, desc: '造成 20 真实伤害；再按剧毒与出血总层数造成 2 倍伤害，不清层。按总层数获得至多 8 庇护。' },
        ...
        { id: 's_energy', name: '风王束羽', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 1, icon: '🍃', val: 0, tags: ['蓄力'], rarity: '史诗', isSpecial: true, desc: '获得 3 层风势并抽 2 张牌；若已有风势，回复 1 点能量。' },
        ...
        { id: 'a_gale_verdict', name: '风冠裁矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '💨', val: 14, tags: ['穿甲'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 14 点[穿甲]；消耗至多 3 层风势，每层追加 6 伤害并获得 1 庇护。' },
        ...
        { id: 'a_bloodlet_gale', name: '断脉赤绽', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '攻击', cost: 1, icon: '🩸', val: 6, tags: ['放血', '抽牌'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害并触发[放血]。成功引爆出血时，额外[抽牌] 1 张；若敌方有[剧毒]，不清空出血。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        { id: 'w_oath_clock', name: '誓钟回击', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_crown_riposte_art_v1.webp', type: '能力', cost: 3, icon: '🕰️', val: 0, tags: ['反击', '保留'], buildTags: ['oathblade'], rarity: '史诗', isSpecial: true, desc: '进入[反击]并[保留]手牌。' },
        { id: 'w_exec_silence', name: '断声处决', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '能力', cost: 1, icon: '⛓️', val: 0, tags: ['眩晕', '易伤'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '施加[眩晕]与[易伤]。' },
        { id: 'w_exec_line', name: '银线断甲', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 2, icon: '🗡️', val: 13, tags: ['穿甲', '连击'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 13 点[穿甲]伤害；若本回合已出牌，触发[连击]。' },
        { id: 'w_exec_flash', name: '白刃瞬裁', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 0, icon: '⚡', val: 7, tags: ['穿甲', '销毁'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 7 点[穿甲]伤害后[销毁]。' },
        { id: 'w_exec_claim', name: '认罪剑痕', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 1, icon: '⚖️', val: 8, tags: ['易伤', '重击'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 8 点[重击]伤害并施加[易伤]。' },
        ...
        { id: 'w_exec_finisher', name: '裂冠终斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_final_judgement_art_v1.webp', type: '攻击', cost: 3, icon: '👑', val: 18, tags: ['穿甲', '重击'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 18 点[穿甲][重击]伤害。' },
        { id: 'w_blood_crucible', name: '血誓坩埚', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '🏺', val: 0, tags: ['血誓', '抽牌'], bloodOathCost: 8, drawCount: 2, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 8 点生命并抽 2 张牌。' },
        { id: 'w_blood_rain', name: '赤雨冲锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 14, tags: ['血誓'], bloodOathCost: 5, bloodOathMissingRatio: 0.55, bloodDebtBleed: 5, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 5 点生命；造成 14 点伤害；追加已损生命 55% 的伤害并施加 5 层出血。' },
        ...
        { id: 'w_blood_drum', name: '战血鼓誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 0, icon: '🥁', val: 0, tags: ['血誓'], bloodOathCost: 5, directEffects: { energy: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 5 点生命并回复 1 点能量。' },
        { id: 'w_blood_chain', name: '赤链二斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '攻击', cost: 1, icon: '⛓️', val: 7, tags: ['血誓', '连击'], bloodOathMissingRatio: 0.55, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 7 点伤害；追加已损生命 55% 的伤害；若本回合已出牌，触发[连击]。' },
        { id: 'w_blood_oathmark', name: '血印再立', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '📜', val: 0, tags: ['血誓', '抽牌'], bloodOathCost: 6, drawCount: 2, directEffects: { draw: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 6 点生命并抽 2 张牌。' },
    ...
    hero_mage: [
        ...
        { id: 'm_mirror_hallway', name: '折廊回声', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 2, icon: '🏛️', val: 0, tags: ['回响', '保留'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌，并使下一次伤害提高 6；回响时再次提高 6。打出后下回合回到手牌。' },
    ...
    hero_archer: [
        { id: 'a_gale_updraft', name: '扶摇羽誓', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '🪶', val: 0, tags: ['蓄力', '闪避', '抽牌'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '获得风势、[闪避]并[抽牌]。' },
        ...
        { id: 'a_gale_crosswind', name: '侧风裁痕', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '📏', val: 0, tags: ['自然', '闪避', '易伤'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '触发[自然]，获得[闪避]并施加[易伤]。' },
        { id: 'a_gale_featherbank', name: '百羽开匣', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_barrage_art_v1.webp', type: '攻击', cost: 2, icon: '🏹', val: 6, tags: ['追击', '抽牌'], buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '造成 6 点伤害，触发[追击]并[抽牌]。' },
        ...
        { id: 'a_exile_map', name: '失林星图', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '能力', cost: 1, icon: '🗺️', val: 0, tags: ['放逐', '抽牌'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '自身[放逐]并[抽牌]；进入放逐区时造成 5 点[流动伤害]。' },
        { id: 'a_exile_recall', name: '归巢双令', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ready_art_v1.webp', type: '能力', cost: 1, icon: '🧭', val: 0, tags: ['回收'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '自动从放逐区回收 1 张牌到手牌，再回收 1 张洗入抽牌堆；每回收放逐牌造成 7 点[流动伤害]。' },
        { id: 'a_exile_knives', name: '影匣短刃', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 0, icon: '🗡️', val: 4, tags: ['销毁'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '造成 4 点伤害后[销毁]，销毁时造成 4 点[流动伤害]。' },
...
const RELIC_POOL = [
    ...
    { id: 'r_exile_cache', name: '流亡箭匣', icon: '📦', desc: '弓手：牌进入放逐区时额外造成 3 点流动伤害并获得 1 层风势；每场战斗首次进入放逐区时获得 1 层[闪避]。带[放逐]的攻击牌额外造成 2 点伤害。', price: 200 },
...
const BUILD_EXPANSION_RELICS = [
    ...
    { id: 'r_blood_suture', name: '赤线缝针', icon: '🧵', desc: '战士：每回合首次因[血誓]失去生命时，少失去 1 点生命，并获得 3 点本回合伤害。', price: 160 },
    ...
    { id: 'r_lifedebt_scale', name: '命痕天平', icon: '⚖️', desc: '战士：生命低于一半时，[血誓]追加伤害与[吸血]回复量提高 25%。', price: 190 },
