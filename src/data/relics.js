...
const SPECIAL_EPIC_POOLS = {
    hero_warrior: [
        ...
        { id: 'a_syn_blood', name: '血海终誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 16, tags: ['血债', '吸血'], lifestealRatio: 1, bloodDebtSpendAll: true, bloodDebtSpendDamage: 2, rarity: '史诗', isSpecial: true, desc: '造成 16 点穿甲伤害；耗尽血债，每点追加 2 伤害；以全部伤害[吸血]。' },
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_blood_drum', name: '战血鼓誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 0, icon: '🥁', val: 0, tags: ['血债'], bloodDebtGain: 4, directEffects: { energy: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '获得 4 点[血债]并回复 1 点能量。' },
        { id: 'w_blood_chain', name: '赤链二斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '攻击', cost: 1, icon: '⛓️', val: 7, tags: ['血债', '连击'], bloodDebtDamageRatio: 1, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成 7 点伤害；追加血债 100% 伤害；若本回合已出牌，触发[连击]。' },
...
const RELIC_POOL = [
    ...
    { id: 'r_vamp_ring', name: '血誓指环', icon: '💍', desc: '战士：[吸血]偿清血债并产生溢出治疗时，本场战斗伤害提高，单次最多提高 3。', price: 140 },
...
const BUILD_EXPANSION_RELICS = [
    ...
    { id: 'r_blood_suture', name: '赤线缝针', icon: '🧵', desc: '战士：每回合首次获得血债时，少获得 1 点血债，并获得 3 点本回合伤害。', price: 160 },
    { id: 'r_vein_cup', name: '脉搏圣杯', icon: '🍷', desc: '战士：每次施加[出血]时，偿还 1 点血债。', price: 170 },
    { id: 'r_rupture_charm', name: '裂口护符', icon: '💔', desc: '战士：触发[放血]后，若清空了出血，额外施加 2 层[出血]并偿还 1 点血债。', price: 170 },
    { id: 'r_lifedebt_scale', name: '命债天平', icon: '⚖️', desc: '战士：生命低于一半时，[吸血]的偿债与回复总量提高 25%；每回合首次完全清偿血债时回复 4 点生命。', price: 190 },
    ...
    { id: 'r_oath_transfusion', name: '誓血导管', icon: '🧪', desc: '战士：每场战斗第一次一次性清偿至少 8 点血债时，回复 1 点能量。', price: 180 },
