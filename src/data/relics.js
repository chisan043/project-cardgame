...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_mage: [
        { id: 's_magic', name: '镜界复写', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_cascade_art_v1.webp', type: '能力', cost: 1, icon: '🌌', val: 0, tags: ['复刻'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌两次并抽 1；无目标时抽 3 张牌。' },
    ...
    hero_archer: [
        ...
        { id: 'a_skyfall_shot', name: '坠星绝矢', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 2, icon: '🌠', val: 22, tags: ['放逐', '穿甲', '追击'], rarity: '史诗', isSpecial: true, desc: '造成 22 点[穿甲]伤害并[放逐]，进入放逐区时造成 5 点[流动伤害]。放逐区每有 2 张牌，此牌额外造成 5 点伤害。' }
    ]
};
...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_exec_line', name: '银线破甲', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 1, icon: '🗡️', val: 34, tags: ['穿甲', '连击', '易伤'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成 34 点[穿甲]伤害并施加[易伤]；若本回合已出牌，伤害提高 50%。' },
        ...
        { id: 'w_blood_drum', name: '血鼓战誓', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 0, icon: '🥁', val: 0, tags: ['血誓'], bloodOathCost: 4, directEffects: { energy: true, draw: true }, drawCount: 1, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 4 点生命，回复 1 点能量并抽 1 张牌。' },
