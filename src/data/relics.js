...
const BUILD_EXPANSION_SPECIAL_EPICS = {
    hero_warrior: [
        ...
        { id: 'w_exec_line', name: '银线断甲', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 2, icon: '🗡️', val: 22, tags: ['穿甲', '连击'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成[穿甲]伤害；若本回合已出牌，伤害提高 50%。' },
        { id: 'w_exec_flash', name: '白刃瞬裁', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_flash_art_v1.webp', type: '攻击', cost: 0, icon: '⚡', val: 12, tags: ['穿甲', '销毁'], buildTags: ['execution'], rarity: '史诗', isSpecial: true, desc: '造成[穿甲]伤害后[销毁]。' },
        ...
        { id: 'w_blood_crucible', name: '血誓坩埚', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '🏺', val: 0, tags: ['血誓', '抽牌'], bloodOathCost: 6, drawCount: 3, directEffects: { draw: true, energy: true }, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 6 点生命，抽 3 张牌并回复 1 点能量。' },
        { id: 'w_blood_rain', name: '赤雨冲锋', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_vow_slash_art_v1.webp', type: '攻击', cost: 2, icon: '🩸', val: 18, tags: ['血誓'], bloodOathCost: 4, bloodOathMissingRatio: 0.6, bloodDebtBleed: 8, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 4 点生命；造成伤害；血誓追加伤害并施加 8 层出血。' },
        ...
        { id: 'w_blood_chain', name: '赤链二斩', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_frenzy_cleave_art_v1.webp', type: '攻击', cost: 1, icon: '⛓️', val: 10, tags: ['血誓', '连击'], bloodOathMissingRatio: 0.6, bloodDebtWeak: 1, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '造成伤害；血誓追加伤害；若本回合已出牌，伤害提高 50%，并施加 1 层[虚弱]。' },
        { id: 'w_blood_oathmark', name: '血印再立', roleId: 'hero_warrior', frameTheme: 'warrior', art: 'assets/cards/art/warrior/warrior_blood_wall_art_v1.webp', type: '能力', cost: 1, icon: '📜', val: 0, tags: ['血誓', '抽牌'], bloodOathCost: 5, drawCount: 2, directEffects: { draw: true, protection: true }, protectVal: 8, buildTags: ['bloodoath'], rarity: '史诗', isSpecial: true, desc: '失去 5 点生命，抽 2 张牌并获得 8 点[庇护]。' },
    ...
    hero_mage: [
        ...
        { id: 'm_chant_bolt', name: '星涌雷令', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '⚡', val: 14, tags: ['爆发', '充能'], buildTags: ['chant'], rarity: '史诗', isSpecial: true, desc: '造成伤害，附带[爆发]并回复 1 点能量。' },
        ...
        { id: 'm_mirror_footnote', name: '镜页脚注', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_star_copy_art_v1.webp', type: '能力', cost: 0, icon: '📝', val: 0, tags: ['复刻', '销毁'], directEffects: { draw: true }, buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '复制上一张非复刻牌并抽 1 张牌，打出后[销毁]。' },
        { id: 'm_mirror_hallway', name: '折廊回声', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_loop_art_v1.webp', type: '能力', cost: 1, icon: '🏛️', val: 0, tags: ['回响', '保留'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '抽 1 张牌，并使下一次伤害提高 10；回响时再次提高 10。打出后下回合回到手牌。' },
        { id: 'm_mirror_glassbolt', name: '镜棱短雷', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_thunder_art_v1.webp', type: '攻击', cost: 1, icon: '💠', val: 12, tags: ['回响', '穿甲'], buildTags: ['mirror'], rarity: '史诗', isSpecial: true, desc: '造成[穿甲]伤害，并让本牌再触发一次。' },
        { id: 'm_calamity_plague_star', name: '疫星坠落', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_stasis_hex_art_v1.webp', type: '能力', cost: 1, icon: '☠️', val: 0, tags: ['诅咒', '虚弱'], directEffects: { draw: true }, buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '施加[诅咒]与[虚弱]并抽 1 张牌。' },
        { id: 'm_calamity_black_snow', name: '黑雪预兆', roleId: 'hero_mage', frameTheme: 'mage', art: 'assets/cards/art/mage/mage_omen_art_v1.webp', type: '攻击', cost: 1, icon: '🌑', val: 10, tags: ['虚弱', '燃烧'], directEffects: { draw: true }, buildTags: ['calamity'], rarity: '史诗', isSpecial: true, desc: '造成伤害，施加[虚弱]与[燃烧]并抽 1 张牌。' },
    ...
    hero_archer: [
        { id: 'a_gale_updraft', name: '扶摇羽誓', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '🪶', val: 8, tags: ['蓄力', '闪避'], directEffects: { draw: true }, sidestepVal: 1, buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '获得风势与[闪避]并抽 1 张牌。' },
        ...
        { id: 'a_gale_crosswind', name: '侧风裁痕', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shift_art_v1.webp', type: '能力', cost: 1, icon: '📏', val: 1, tags: ['自然', '闪避', '易伤'], directEffects: { draw: true }, sidestepVal: 1, buildTags: ['gale'], rarity: '史诗', isSpecial: true, desc: '触发[自然]，获得[闪避]，施加[易伤]并抽 1 张牌。' },
        ...
        { id: 'a_venom_bloom', name: '毒花齐绽', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 1, icon: '🌿', val: 0, tags: ['剧毒', '出血'], directEffects: { draw: true }, buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '施加[剧毒]与[出血]并抽 1 张牌。' },
        { id: 'a_venom_burst', name: '毒脉爆箭', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_blood_release_art_v1.webp', type: '攻击', cost: 1, icon: '☠️', val: 9, tags: ['放血', '剧毒'], directEffects: { draw: true }, buildTags: ['venom'], rarity: '史诗', isSpecial: true, desc: '造成伤害，触发[放血]，施加[剧毒]并抽 1 张牌。' },
        ...
        { id: 'a_exile_knives', name: '影匣短刃', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_shadow_art_v1.webp', type: '攻击', cost: 0, icon: '🗡️', val: 12, tags: ['销毁'], buildTags: ['exile'], rarity: '史诗', isSpecial: true, desc: '造成伤害后[销毁]，销毁时造成[流动伤害]。' },
