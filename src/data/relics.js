...
const SPECIAL_EPIC_POOLS = {
    ...
    hero_archer: [
        ...
        { id: 's_poison', name: '猎毒齐爆', roleId: 'hero_archer', frameTheme: 'archer', art: 'assets/cards/art/archer/archer_ambush_art_v1.webp', type: '能力', cost: 2, icon: '💥', val: 44, tags: ['剧毒', '出血'], rarity: '史诗', isSpecial: true, desc: '造成 44 真实伤害；再按剧毒与出血总层数造成 5 倍伤害，不清层。按总层数获得至多 18 庇护。' },
