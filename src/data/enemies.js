...
const ENEMIES = [
    ...
    { name: "堕落剑客", icon: "🤺", baseHp: 110, tier: 3, ai: { type: 'tactical', aggression: 1.25, opener: 1, maxNonAttack: 1 }, moves: [{type:'attack', val:6, name:"燕返三连斩", times: 3}, {type:'buff', val:3, name:"剑气汇聚"}, {type:'seal', val:1, name:"挑飞武器"}, {type:'attack', val:18, name:"堕影居合"}] },
    ...
    { name: "巨力石魔", icon: "🪨", baseHp: 150, tier: 3, ai: { type: 'tactical', aggression: 1.1, opener: 2, maxNonAttack: 1 }, moves: [{type:'charge', val:0, name:"大地共鸣"}, {type:'attack', val:26, name:"崩天陨星击"}, {type:'defend', val:20, name:"磐石之护"}, {type:'attack', val:10, name:"碎岩横扫", times: 2}] },
    ...
    { name: "【精英】狂暴牛头人", icon: "🐂", baseHp: 180, type: 'elite', tier: 1, ai: { type: 'tactical', aggression: 1.35, opener: 2, maxNonAttack: 1 }, moves: [{type:'charge', val:0, name:"战争践踏"}, {type:'attack', val:23, name:"毁灭打击"}, {type:'buff', val:3, name:"血怒咆哮"}, {type:'attack', val:9, name:"蛮角连冲", times: 3}] },
    ...
    { name: "【精英】不死骨龙", icon: "🐉", baseHp: 220, type: 'elite', tier: 3, ai: { type: 'tactical', aggression: 1.3, opener: 1, maxNonAttack: 1 }, moves: [{type:'attack', val:9, name:"幽冥龙息", times:3}, {type:'debuff', subType:'vuln', val:3, name:"龙威震慑"}, {type:'buff_thorns', val:5, name:"骨刺横生"}, {type:'attack', val:28, name:"骨翼俯冲"}] },

    { name: "【首领】鬼面修罗", icon: "👹", baseHp: 350, type: 'boss', ai: { type: 'tactical', aggression: 1.3, opener: 0, maxNonAttack: 1 }, moves: [{type:'summon', val:50, atk:8, name:"唤醒法相"}, {type:'attack', val:8, name:"修罗连斩", times:3}, {type:'seal', val:2, name:"六道封禁"}, {type:'charge', val:0, name:"魔气内敛"}, {type:'attack', val:35, name:"修罗一击"}, {type:'debuff', subType:'vuln', val:3, name:"鬼面威压"}] },
    { name: "【深渊主宰】", icon: "👁️", baseHp: 400, type: 'boss', 
        ai: { type: 'tactical', aggression: 1.25, opener: 0, maxNonAttack: 1 },
        moves: [{type:'summon', val:60, atk:10, name:"深渊触须"}, {type:'junk', val:3, name:"理智剥夺"}, {type:'attack', val:12, name:"精神鞭笞", times:2}, {type:'debuff', subType:'weak', val:3, name:"深渊凝视"}, {type:'debuff', subType:'curse', val:2, name:"梦魇回声"}, {type:'attack', val:22, name:"虚空碾压"}],
        phase2: { name: "【深渊主宰·暴走】", icon: "🌌", maxHp: 350, ai: { type: 'tactical', aggression: 1.45, opener: 0, maxNonAttack: 1 }, moves: [{type:'attack', val:15, name:"湮灭射线", times:3}, {type:'seal', val:3, name:"秩序崩坏"}, {type:'charge', val:0, name:"深渊坍缩"}, {type:'attack', val:50, name:"纪元终结"}, {type:'junk', val:2, name:"残卷污染"}] }
    }
];
