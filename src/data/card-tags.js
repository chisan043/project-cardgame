...
const TAGS = {
    ...
    '血债': '借生命换爆发。3 回合内用吸血或偿债还清；未还清时受到清算伤害。血债不会让生命直接低于 1 点。',
    ...
    '回收': '按卡牌说明，自动从墓地或放逐区回收牌，送回手牌或抽牌堆。回收放逐牌时造成 7 点流动伤害。',
    ...
    '咏唱': '法师通用资源：积累 {val} 层咏唱并获得 4 点护盾；爆发牌会消耗咏唱造成额外伤害。',
    '爆发': '法师专属：攻击会消耗所有咏唱层数，每层追加 8 点伤害并获得 1 点庇护，庇护最多 8 点；没有咏唱时仍追加 4 点伤害。',
    ...
    '流动伤害': '放逐游侠专属伤害：放逐流派牌进入墓地造成 3 点穿甲伤害，进入放逐区造成 5 点，回收造成 7 点，销毁造成 4 点。'
};
...
const STATUS_DESC = {
    ...
    chant: '<span style="color:var(--purple); font-weight:bold;">咏唱</span><br>法师的爆发牌会消耗咏唱层数，每层追加 8 点伤害。',
