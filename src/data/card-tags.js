...
const TAGS = {
    ...
    '血祭': '失去 5 点生命，本场战斗所有伤害 +{val}。未升级为 +4，升级后为 +6。',
    ...
    '燃烧': '施加 2 层燃烧(每层每回合造成最大生命 5% 的伤害并衰减)。',
    '眩晕': '施加 1 层眩晕(跳过下一次行动回合)。',
    '诅咒': '施加 2 层诅咒(无法恢复生命并随回合衰减)。',
    '放血': '引爆敌方的出血状态，每层造成 3 点伤害，随后清空。',
    '重击': '基础数值伤害翻倍。',
    '穿甲': '无视敌方护甲，直接扣除生命。',
    '圣剑': '战士专属攻击词条：额外造成当前护盾 50% 的伤害，反击姿态再 +4；拥有圣剑誓印时护盾比例提高到 75%。',
    '咏唱': '法师专属：积累 {val} 层咏唱，之后的爆发牌会消耗咏唱造成额外伤害。',
    '爆发': '法师专属：攻击会消耗所有咏唱层数，每层追加 7 点伤害；没有咏唱时仍追加 4 点伤害。',
...
const STATUS_DESC = {
    ...
    burn: '<span style="color:var(--fire); font-weight:bold;">燃烧</span><br>每层每回合造成最大生命 5% 的伤害。触发后层数减少1层。',
